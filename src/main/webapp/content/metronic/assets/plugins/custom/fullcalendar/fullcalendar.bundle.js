...
var FullCalendar = (function (e) {
  ...
  function T(e, t, n) {
    ...
    for (r = 0; r < e.__k.length; r++)
      (o = e.__k[r]) && ((o.__ = e), (t = 'function' == typeof o.type ? T(o, t, n) : C(n, o, o, e.__k, o.__e, t)));
    return t;
  }
  function x(e, t) {
    return (
        ...
        if (
          ...
          n.__c
            ...
            : ('prototype' in x && x.prototype.render
                ? (t.__c = d = new x(b, w))
                : ((t.__c = d = new y(b, w)), (d.constructor = x), (d.render = O)),
              S && S.sub(d),
              (d.props = b),
              d.state || (d.state = {}),
              (d.context = w),
          ...
          null != x.getDerivedStateFromProps &&
            (d.__s == d.state && (d.__s = f({}, d.__s)), f(d.__s, x.getDerivedStateFromProps(b, d.__s))),
          (h = d.props),
          (v = d.state),
          p)
        )
  ...
  function N(e, t, n, r, o, i, a, s) {
    ...
    if (null === m) v === g || (s && e.data === g) || (e.data = g);
      ...
      if (
        ...
        ((y = t.props.children), D(e, Array.isArray(y) ? y : [y], t, n, r, o && 'foreignObject' !== m, i, a, e.firstChild, s), null != i)
      )
  ...
  function Xn(e, t, n, r) {
    ...
    for (var c in e.defs) {
      'inverse-background' === (f = u[(b = e.defs[c]).defId]).display &&
        (b.groupId ? ((o[b.groupId] = []), a[b.groupId] || (a[b.groupId] = b)) : (i[c] = []));
    }
          ...
          if (e instanceof _r) {
            ...
            return (
              this.getCurrentData().eventStore.defs[n.defId] ||
                (this.dispatch({ type: 'ADD_EVENTS', eventStore: bn({ def: n, instance: r }) }), this.triggerEventAdd(e)),
              e
            );
          }
          var o,
  ...
  var Lr = (function () {
      ...
      return (
        ...
        (e.prototype.diffWholeYears = function (e, t) {
          ...
          return gt(e) === gt(t) && n.getMarkerDay(e) === n.getMarkerDay(t) && n.getMarkerMonth(e) === n.getMarkerMonth(t)
  ...
  function co() {
    return (
      null === uo &&
        (uo = (function () {
          var e = document.createElement('div');
          Te(e, { position: 'absolute', top: -1e3, left: 0, border: 0, padding: 0, overflow: 'scroll', direction: 'rtl' }),
            (e.innerHTML = '<div></div>'),
            document.body.appendChild(e);
    ...
    return (
      ...
      (t.prototype.shouldComponentUpdate = function (e, t) {
        return (
          ...
          !Ct(this.props, e, this.propEquality) || !Ct(this.state, t, this.stateEquality)
        );
      }),
          ...
          return (
            e && e.contentKey === n.contentKey
              ...
              : (e && (e.destroy && e.destroy(), (e = this.customContentInfo = null)),
                n.contentKey &&
                  (e = this.customContentInfo = r({ contentKey: n.contentKey, contentVal: t[n.contentKey] }, n.buildLifecycleFuncs()))),
            e ? [] : t
          );
        }),
    ...
    return (
      ...
      (e.prototype.adjustActiveRange = function (e) {
        var t = this.props,
          ...
          s = e.end;
        return (
          r && (Lt(o) < 0 && ((a = lt(a)), (a = n.add(a, o))), Lt(i) > 1 && ((s = tt((s = lt(s)), -1)), (s = n.add(s, i)))),
          { start: a, end: s }
        );
      }),
        ...
        if (m && m !== y)
          for (var E in (m.timeZone !== y.timeZone &&
            ((d.eventSources = v.eventSources =
              ((a = v.eventSources), (s = d.dateProfile), (l = v), (u = s ? s.activeRange : null), pi(a, hi(a, l), u, !0, l))),
    ...
    qi = (function () {
      ...
      return (
        ...
        (e.prototype.splitEntry = function (e, t, n) {
          ...
          return (
            a.start < s.start &&
              (r += this.insertEntry({ index: e.index, thickness: e.thickness, span: { start: a.start, end: s.start } }, i)),
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return (
            ...
            Co(
              'div',
              { 'aria-labelledby': e.labeledById, ref: this.handleEl, className: r.join(' '), style: { height: o, paddingBottom: i } },
              e.children
            )
          );
        }),
      ...
      return (
        ...
        (t.prototype.triggerEvent = function (e, t, n) {
          ...
          (t && !r.isValidSegDownEl(t.target)) ||
            o.emitter.trigger(e, { el: n, event: new _r(o, i.eventRange.def, i.eventRange.instance), jsEvent: t, view: o.viewApi });
        }),
        t
      );
    })(ea),
            ...
            function (e, t, n, o) {
              return Co(
                ...
                Co(
                  ...
                  !u.isDisabled &&
                    Co('a', r({ ref: n, className: ['fc-col-header-cell-cushion', a.isSticky ? 'fc-sticky' : ''].join(' ') }, p), o)
                )
              );
            }
          );
    ...
    Da = (function (e) {
      ...
      return (
        ...
        (t.prototype.computeTiming = function () {
          ...
          return (
            (i = Math.min(864e5, i)),
            { currentState: { nowDate: r, todayRange: Ta(r) }, nextState: { nowDate: o, todayRange: Ta(o) }, waitMs: i }
          );
        }),
      ...
      (t.prototype.render = function () {
        ...
        return Co(Da, { unit: 'day' }, function (e, t) {
          return Co(
            ...
            n.map(function (e) {
              return o
                ? Co(ba, { key: e.toISOString(), date: e, dateProfile: r, todayRange: t, colCnt: n.length, dayHeaderFormat: a })
                : Co(wa, { key: e.getUTCDay(), dow: e.getUTCDay(), dayHeaderFormat: a });
            })
          );
        });
      }),
  ...
  function Ya(e, t) {
    for (var n = [], r = 0, i = e; r < i.length; r++)
      for (var a = i[r], s = a.span || 1, l = 0; l < s; l += 1)
        n.push(Co('col', { style: { width: 'shrink' === a.width ? Za(t) : a.width || '', minWidth: a.minWidth || '' } }));
  ...
  function os(e) {
    return Co(
      ...
      Co(
        ...
        Co('div', { className: 'fc-event-title fc-sticky' }, e.event.title || Co(_o, null, ' '))
      )
    );
  }
  var is = function (e) {
              ...
              ko(
                Co(ga, { options: e.calendarOptions, theme: e.theme, emitter: e.emitter }, function (t, n, i, a) {
                  return (
                    o.setClassNames(t),
                    o.setHeight(n),
                    Co(Zo.Provider, { value: o.customContentRenderId }, Co(fa, r({ isHeightAuto: i, forPrint: a }, e)))
                  );
                }),
                o.el
              );
  ...
  var _s = (function () {
      ...
      return (
        ...
        (e.prototype.updateElPosition = function () {
          this.sourceEl &&
            this.isVisible &&
            Te(this.getMirrorEl(), { left: this.sourceElRect.left + this.deltaX, top: this.sourceElRect.top + this.deltaY });
        }),
              ...
              i === a || (d.editable && d.droppable)
                ? (s = (function (e, t, n) {
                    var r = e.dateSpan,
                      ...
                      s = {};
                    r.allDay !== o.allDay &&
                      ((s.allDay = o.allDay), (s.hasEnd = t.context.options.allDayMaintainDuration), o.allDay && (i = lt(i)));
          ...
          if (o.isDragging) {
            ...
            if ((o.clearDrag(), t.emitter.trigger('eventDragStop', { el: o.subjectEl, event: c, jsEvent: e.origEvent, view: n }), s)) {
              if (a === t) {
                ...
                t.emitter.trigger('eventLeave', r(r({}, b), { draggedEl: e.subjectEl, view: n })),
                ...
                a.emitter.trigger('eventAdd', T),
                  ...
                  a.emitter.trigger(
                    'drop',
                    r(r({}, Ws(f.dateSpan, a)), { draggedEl: e.subjectEl, jsEvent: e.origEvent, view: f.context.viewApi })
                  ),
      ...
      (n.draggingSegEl = null),
        ...
        (n.handleDragStart = function (e) {
          ...
          (n.draggingSegEl = o),
            ...
            t.emitter.trigger('eventResizeStart', { el: o, event: new _r(t, r.def, r.instance), jsEvent: e.origEvent, view: t.viewApi });
        }),
          ...
          (this.handleDragEnd = function (e) {
            ...
            if ((n.clearDrag(), o && i)) {
              var a = n.hitDragging.finalHit,
                ...
                l = n.dragMeta;
              if (
                (o.emitter.trigger('drop', r(r({}, Ws(a.dateSpan, o)), { draggedEl: e.subjectEl, jsEvent: e.origEvent, view: s })),
                l.create)
              ) {
                var u = bn(i);
          ...
          return (
            ...
            Co(ti, { viewSpec: r.viewSpec }, function (e, t) {
              return Co(
                ...
                Co(ts, { liquid: !n.isHeightAuto && !n.forPrint, collapsibleWidth: n.forPrint, cols: [], sections: o })
              );
            })
          );
        }),
                ...
                n.map(function (n) {
                  ...
                  return Co(
                    ...
                    il(n)
                      ? Co(
                          sl,
                          r({ seg: n, isDragging: !1, isSelected: o === e.eventSelection, defaultDisplayEventEnd: !1 }, sr(n, e.todayRange))
                        )
                      : Co(
                          al,
                          r(
  ...
  function fl(e, t, n, r, o, i, a) {
    ...
    for (
        ...
        f = (function (e, t, n) {
          for (
            ...
            for (var l = r[s], u = [], c = 0, d = 0, p = 0, f = l; p < f.length; p++) {
              var h = t[(y = f[p]).index];
              u.push({ seg: hl(h, s, s + 1, n), isVisible: !0, isAbsolute: !1, absoluteTop: y.levelCoord, marginTop: y.levelCoord - c }),
      ...
      for (var S = x.firstCol; S <= x.lastCol; S += 1)
        h[S].push({ seg: hl(x, S, S + 1, a), isVisible: !1, isAbsolute: !1, absoluteTop: 0, marginTop: 0 });
    }
    ...
    for (var w = 0, D = p; w < D.length; w++) {
      ...
      for (S = C.start; S < C.end; S += 1)
        (m[S] += 1), h[S].push({ seg: hl(x, S, S + 1, a), isVisible: !1, isAbsolute: !1, absoluteTop: 0, marginTop: 0 });
    }
            ...
            for (var h = 0, v = t; h < v.length; h++) {
              ...
              S &&
                (l.isRtl
                  ...
                  : ((w = 0), (D = c.rights[m.firstCol] - c.rights[m.lastCol]))),
                f.push(
                  Co(
                    'div',
                    {
      ...
      return (
        ...
        (t.prototype.render = function () {
          var e = this,
            ...
            a =
              n.dayHeaders &&
              Co(xa, { ref: this.headerRef, dateProfile: o.dateProfile, dates: i.headerDates, datesRepDistinctDays: 1 === i.rowCnt }),
            s = function (t) {
              return Co(bl, {
                ref: e.tableRef,
        ...
        function (n, r, o, i) {
          return Co(
            ...
            Co(
              ...
              Co('div', { className: 'fc-timegrid-slot-label-cushion fc-scrollgrid-shrink-cushion', ref: o }, i)
            )
          );
        }
      );
              ...
              ? Co(fs, { date: i.start, defaultFormat: Ml }, function (e, t, o, i) {
                  return Co(
                    ...
                    Co(
                      ...
                      Co(
                        'a',
                        r({ ref: o, className: 'fc-timegrid-axis-cushion fc-scrollgrid-shrink-cushion fc-scrollgrid-sync-inner' }, a),
                        i
                      )
                    )
                  );
          ...
          return (
            ...
            Co(ti, { viewSpec: r.viewSpec, elRef: this.rootElRef }, function (e, t) {
              return Co(
                ...
                Co(ts, { liquid: !o.isHeightAuto && !o.forPrint, collapsibleWidth: o.forPrint, cols: [{ width: 'shrink' }], sections: i })
              );
            })
          );
        }),
            ...
            t &&
              ...
              f.push({
                ...
                outerContent: Co(
                  'tr',
                  { role: 'presentation', className: 'fc-scrollgrid-section' },
                  Co('td', { colSpan: 2, className: 'fc-timegrid-divider ' + u.theme.getClass('tableCellShaded') })
                ),
              }));
          ...
          n = jl(
            ...
            function (o, i) {
              var a = (function (e, t, n) {
                  ...
                  for (; l < s; l += 1) {
                    for (
                      var u = o[l], c = void 0, d = Qi(u, i.span.start, Yi), p = d[0] + d[1], f = p;
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return (
            ...
            Co(rs, r({}, this.props, { defaultTimeFormat: ql, extraClassNames: e }))
          );
        }),
        t
      );
        ...
        (t.prototype.renderFillSegs = function (e, t) {
          var n = this.props,
            ...
            i = Gl(e, n.date, n.slatCoords, o.options.eventMinHeight).map(function (o, i) {
              ...
              return Co(
                'div',
                { key: ur(a.eventRange), className: 'fc-timegrid-bg-harness', style: $l(o) },
    ...
    return Co(
      ...
      e.map(function (e) {
        ...
        return Co(
          ...
          Co(Yl, r({ seg: e, isDragging: !1, isResizing: !1, isDateSelecting: !1, isSelected: t === i, isShort: !1 }, sr(e, n, o)))
        );
      })
    );
  }
    ...
    return (
      ...
      (t.prototype.render = function () {
        var e = this,
          ...
          h =
            n.dayHeaders &&
            Co(xa, { dates: l.headerDates, dateProfile: s, datesRepDistinctDays: !0, renderIntro: p ? this.renderHeadAxis : null }),
          v =
            !1 !== n.allDaySlot &&
            function (t) {
              return Co(
  ...
  function cu(e) {
    return Co(
      _o,
      null,
      e.text && Co('a', r({ id: e.textId, className: 'fc-list-day-text' }, e.navLinkAttrs), e.text),
      e.sideText && Co('a', r({ 'aria-hidden': !0, className: 'fc-list-day-side-text' }, e.sideNavLinkAttrs), e.sideText)
    );
  }
            ...
            function (e, r, l, u, c) {
              return Co(
                ...
                Co(
                  ...
                  Co('span', { className: 'fc-list-event-dot', style: { borderColor: c.borderColor || c.backgroundColor } })
                ),
