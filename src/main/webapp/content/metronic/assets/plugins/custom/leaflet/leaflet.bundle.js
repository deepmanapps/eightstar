...
!(function (t, e) {
  ...
  function f(t, e) {
    return t.replace(m, function (t, i) {
      if (void 0 === (i = e[i])) throw new Error('No value provided for variable ' + t);
  ...
  (A.extend = function (t) {
    ...
    return (
      ...
      delete r.statics,
      delete r.includes,
      r.options && ((r.options = s.options ? i(s.options) : {}), e(r.options, t.options)),
      (r._initHooks = []),
          ...
          if (1 === arguments.length) {
            ...
            'function' != typeof e
              ...
              : !1 !== (e = this._listens(t, e, i)) &&
                ((i = n[e]), this._firingCount && ((i.fn = l), (this._events[t] = n = n.slice())), n.splice(e, 1));
      },
      fire: function (t, i, n) {
        if (this.listens(t, n)) {
  ...
  (k.prototype = {
    ...
    (Z.prototype = {
      extend: function (t) {
        var e, i;
        if (t) {
          if (t instanceof k || 'number' == typeof t[0] || 'x' in t) e = i = O(t);
      ...
      contains: function (t) {
        var e, i;
        return (
          (t = ('number' == typeof t[0] || t instanceof k ? O : B)(t)) instanceof Z ? ((e = t.min), (i = t.max)) : (e = i = t),
      ...
      extend: function (t) {
        ...
        return (
          n || o
            ...
            : ((this._southWest = new F(e.lat, e.lng)), (this._northEast = new F(i.lat, i.lng))),
          this
        );
      },
      pad: function (t) {
  ...
  var U = {
      ...
      getProjectedBounds: function (t) {
        ...
        return this.infinite
          ...
          : ((e = this.projection.bounds),
            (t = this.scale(t)),
            new Z(this.transformation.transform(e.min, t), this.transformation.transform(e.max, t)));
      },
      ...
      wrapLatLngBounds: function (t) {
        ...
        return 0 == n && 0 == e
          ? t
          : ((i = t.getSouthWest()), (t = t.getNorthEast()), new R(new F(i.lat - n, i.lng - e), new F(t.lat - n, t.lng - e)));
      },
    },
    j = e({}, U, {
      wrapLng: [-180, 180],
    ...
    G = {
      ...
      project: function (t) {
        ...
        return new k(this.R * t.lng * e, (this.R * Math.log((1 + i) / (1 - i))) / 2);
      },
      unproject: function (t) {
        var e = 180 / Math.PI;
  ...
  var H = e({}, j, { code: 'EPSG:3857', projection: G, transformation: W((H = 0.5 / (Math.PI * G.R)), 0.5, -H, 0.5) }),
  ...
  var Y = document.documentElement.style,
    ...
    ot = ((nt = et && Ct('Google') && nt < 537 && !('AudioNode' in window)), !!window.opera),
    st = !$ && Ct('chrome'),
    rt = Ct('gecko') && !tt && !ot && !Q,
    at = !st && Ct('safari'),
    ht = Ct('phantom'),
    ...
    pt = ((Y = 'MozPerspective' in Y), !window.L_DISABLE_3D && (ct || dt || Y) && !lt && !ht),
    ...
    xt = Wi && ot,
    bt = Wi && rt,
    wt = 1 < (window.devicePixelRatio || window.screen.deviceXDPI / window.screen.logicalXDPI),
    Lt = (function () {
      var t = !1;
      try {
    ...
    St =
      ...
      'http://www.w3.org/2000/svg' === (St.firstChild && St.firstChild.namespaceURI));
  function Ct(t) {
  ...
  var Mt = {
    ...
    Ot = {
      touchstart: function (t, e) {
        e.MSPOINTER_TYPE_TOUCH && e.pointerType === e.MSPOINTER_TYPE_TOUCH && Ae(e), Nt(t, e);
      },
      touchmove: Nt,
      touchend: Nt,
      touchcancel: Nt,
  ...
  var Ut,
    ...
    Wt,
    Ht,
    Vt = le(['transform', 'webkitTransform', 'OTransform', 'MozTransform', 'msTransform']),
    Kt = le(['webkitTransition', 'transition', 'OTransition', 'MozTransition', 'msTransition']),
    Jt = 'webkitTransition' === Kt || 'OTransition' === Kt ? Kt + 'End' : 'transitionend';
  function Yt(t) {
  ...
  function oe(t, e) {
    var i;
    if (void 0 !== t.classList) for (var n = d(e), o = 0, s = n.length; o < s; o++) t.classList.add(n[o]);
  ...
  function ue(t, e, i) {
    (e = e || new k(0, 0)),
      (t.style[Vt] =
        (Mt.ie3d ? 'translate(' + e.x + 'px,' + e.y + 'px)' : 'translate3d(' + e.x + 'px,' + e.y + 'px,0)') +
        (i ? ' scale(' + i + ')' : ''));
  }
  function ce(t, e) {
    (t._leaflet_pos = e), Mt.any3d ? ue(t, e) : ((t.style.left = e.x + 'px'), (t.style.top = e.y + 'px'));
  }
  function de(t) {
  ...
  function me(t) {
    ...
    t.style && (fe(), (Ht = (Wt = t).style.outline), (t.style.outline = 'none'), ye(window, 'keydown', fe));
  }
  function fe() {
    Wt && ((Wt.style.outline = Ht), (Ht = Wt = void 0), be(window, 'keydown', fe));
  }
  function ge(t) {
  ...
  (qt =
    'onselectstart' in document
      ...
      : ((jt = le(['userSelect', 'WebkitUserSelect', 'OUserSelect', 'MozUserSelect', 'msUserSelect'])),
        (Gt = function () {
          var t;
          jt && ((t = document.documentElement.style), (Ut = t[jt]), (t[jt] = 'none'));
        }),
        function () {
  ...
  var Le = { mouseenter: 'mouseover', mouseleave: 'mouseout', wheel: !('onwheel' in window) && 'mousewheel' };
  function Pe(t, e, i, n) {
    var o,
      s,
      a = e + r(i) + (n ? '_' + r(n) : '');
    (t[xe] && t[xe][a]) ||
      ...
      !Mt.touchNative && Mt.pointer && 0 === e.indexOf('touch')
        ? (o = (function (t, e, i) {
            return (
              'touchstart' !== e ||
                ...
                (Bt = !0)),
              Ot[e]
                ? ((i = Ot[e].bind(this, i)), t.addEventListener(Et[e], i, !1), i)
        ...
        ? 'touchstart' === e || 'touchmove' === e || 'wheel' === e || 'mousewheel' === e
          ? t.addEventListener(Le[e] || e, o, !!Mt.passiveEvents && { passive: !1 })
  ...
  function Te(t, e, i, n, o) {
    ...
    (o = o || e + r(i) + (n ? '_' + r(n) : '')),
      (i = t[xe] && t[xe][o]) &&
        (!Mt.touchNative && Mt.pointer && 0 === e.indexOf('touch')
          ? ((n = t), (a = i), Et[(s = e)] ? n.removeEventListener(Et[s], a, !1) : console.warn('wrong event specified:', s))
          : Mt.touch && 'dblclick' === e
          ? ((n = i), (a = t).removeEventListener('dblclick', n.dblclick), a.removeEventListener('click', n.simDblclick))
  ...
  function Me(t) {
    return ye(t, 'mousedown touchstart dblclick contextmenu', Se), (t._leaflet_disable_click = !0), this;
  }
  function Ae(t) {
  ...
  function ke(t, e) {
    var i, n;
    return e
      ? ((n = (i = ve(e)).boundingClientRect), new k((t.clientX - n.left) / i.x - e.clientLeft, (t.clientY - n.top) / i.y - e.clientTop))
  ...
  var Be = I.extend({
      ...
      _runFrame: function (t, e) {
        (t = this._startPos.add(this._offset.multiplyBy(t))), e && t._round(), ce(this._el, t), this.fire('step');
      },
      _complete: function () {
    ...
    Re = I.extend({
      ...
      initialize: function (t, e) {
        (e = p(this, e)),
          ...
          e.center && void 0 !== e.zoom && this.setView(N(e.center), e.zoom, { reset: !0 }),
          this.callInitHooks(),
          (this._zoomAnimated = Kt && Mt.any3d && !Mt.mobileOpera && this.options.zoomAnimation),
          this._zoomAnimated && (this._createAnimProxy(), ye(this._proxy, Jt, this._catchTransitionEnd, this)),
      ...
      zoomIn: function (t, e) {
        return (t = t || (Mt.any3d ? this.options.zoomDelta : 1)), this.setZoom(this._zoom + t, e);
      },
      ...
      setZoomAround: function (t, e, i) {
        ...
        (t = (t instanceof k ? t : this.latLngToContainerPoint(t)).subtract(o).multiplyBy(1 - 1 / n)),
      ...
      fitBounds: function (t, e) {
        if ((t = D(t)).isValid()) return (t = this._getBoundsCenterZoom(t, e)), this.setView(t.center, t.zoom, e);
      ...
      flyTo: function (t, e, i) {
        if (!1 === (i = i || {}).animate || !Mt.any3d) return this.setView(t, e, i);
        this._stop();
        ...
        function d(t) {
          return (
            (t = (h * h - a * a + (t ? -1 : 1) * c * c * l * l) / (2 * (t ? h : a) * c * l)),
                  ...
                  this.unproject(
                    n.add(
                      o.subtract(n).multiplyBy(
                        (function (t) {
                          return (a * (_(m) * (p((t = m + u * t)) / _(t)) - p(m))) / c;
                        })(h) / l
                      )
                    ),
                    r
                  ),
                  this.getScaleZoom(a / ((s = h), a * (_(m) / _(m + u * s))), r),
                  { flyTo: !0 }
                ))
      ...
      panInside: function (t, e) {
        var i = O((e = e || {}).paddingTopLeft || e.padding || [0, 0]),
          ...
          s = ((t = this.project(t)), (i = B([(s = this.getPixelBounds()).min.add(i), s.max.subtract(n)])).getSize());
        return (
          i.contains(t) ||
            ((this._enforcingBounds = !0),
      ...
      invalidateSize: function (t) {
        ...
        var i = this.getSize(),
          n = ((this._sizeChanged = !0), (this._lastCenter = null), this.getSize()),
        ...
        return (s = s.subtract(r)).x || s.y
          ? (t.animate && t.pan
              ...
              : (t.pan && this._rawPanBy(s),
                this.fire('move'),
                t.debounceMoveend
                  ? (clearTimeout(this._sizeTimer), (this._sizeTimer = setTimeout(o(this.fire, this, 'moveend'), 200)))
                  : this.fire('moveend')),
      ...
      createPane: function (t, e) {
        return (
          (e = Xt('div', 'leaflet-pane' + (t ? ' leaflet-' + t.replace('Pane', '') + '-pane' : ''), e || this._mapPane)),
          t && (this._panes[t] = e),
          e
        );
      },
      ...
      containerPointToLatLng: function (t) {
        return (t = this.containerPointToLayerPoint(O(t))), this.layerPointToLatLng(t);
      },
      ...
      _initContainer: function (t) {
        if (!(t = this._container = Yt(t))) throw new Error('Map container not found.');
      ...
      _initPanes: function () {
        ...
        (this._paneRenderers = {}),
          ...
          this.options.markerZoomAnimation || (oe(t.markerPane, 'leaflet-zoom-hide'), oe(t.shadowPane, 'leaflet-zoom-hide'));
      },
      ...
      _initEvents: function (t) {
        ...
        e(
          ...
          Mt.any3d && this.options.transform3DLimit && (t ? this.off : this.on).call(this, 'moveend', this._onMoveEnd);
      },
      _onResize: function () {
      ...
      _fireDOMEvent: function (t, i, n) {
        'click' === t.type && (((h = e({}, t)).type = 'preclick'), this._fireDOMEvent(h, h.type, n));
        var o = this._findEventTargets(t, i);
        if (n) {
          for (var s = [], r = 0; r < n.length; r++) n[r].listens(i, !0) && s.push(n[r]);
          o = s.concat(o);
        }
        if (o.length) {
          'contextmenu' === i && Ae(t);
          ...
          for (
            ...
            if (
              (o[r].fire(i, l, !0), l.originalEvent._stopped || (!1 === o[r].options.bubblingMouseEvents && -1 !== v(this._mouseEvents, i)))
            )
              return;
        }
      },
      ...
      _limitOffset: function (t, e) {
        var i;
        return e ? ((i = new Z((i = this.getPixelBounds()).min.add(t), i.max.add(t))), t.add(this._getBoundsOffset(i, e))) : t;
      },
      _getBoundsOffset: function (t, e, i) {
        return (
          (i = (e = B(this.project(e.getNorthEast(), i), this.project(e.getSouthWest(), i))).min.subtract(t.min)),
      ...
      _tryAnimatedPan: function (t, e) {
        return (
          (t = this._getCenterOffset(t)._trunc()), !((!0 !== (e && e.animate) && !this.getSize().contains(t)) || (this.panBy(t, e), 0))
        );
      },
      ...
      _animateZoom: function (t, e, i, n) {
        this._mapPane &&
          (i &&
            ((this._animatingZoom = !0), (this._animateToCenter = t), (this._animateToZoom = e), oe(this._mapPane, 'leaflet-zoom-anim')),
  ...
  var Fe,
    ...
    Ue =
      (Re.include({
        ...
        _initControlPos: function () {
          var t = (this._controlCorners = {}),
            e = 'leaflet-',
            i = (this._controlContainer = Xt('div', e + 'control-container', this._container));
          function n(n, o) {
      ...
      Ne.extend({
        ...
        expand: function () {
          oe(this._container, 'leaflet-control-layers-expanded'), (this._section.style.height = null);
          var t = this._map.getSize().y - (this._container.offsetTop + 50);
          return (
            t < this._section.clientHeight
              ? (oe(this._section, 'leaflet-control-layers-scrollbar'), (this._section.style.height = t + 'px'))
        ...
        _initLayout: function () {
          var t = 'leaflet-control-layers',
            ...
            n = (e.setAttribute('aria-haspopup', !0), Me(e), Ce(e), (this._section = Xt('section', t + '-list'))),
            o =
              (i &&
        ...
        _checkDisabledLayers: function () {
          for (var t, e, i = this._layerControlInputs, n = this._map.getZoom(), o = i.length - 1; 0 <= o; o--)
            (t = i[o]),
              ...
              (t.disabled =
                (void 0 !== e.options.minZoom && n < e.options.minZoom) || (void 0 !== e.options.maxZoom && n > e.options.maxZoom));
        },
      ...
      _updateDisabled: function () {
        ...
        se(this._zoomInButton, e),
          ...
          (!this._disabled && t._zoom !== t.getMinZoom()) ||
            (oe(this._zoomOutButton, e), this._zoomOutButton.setAttribute('aria-disabled', 'true')),
          (!this._disabled && t._zoom !== t.getMaxZoom()) ||
            (oe(this._zoomInButton, e), this._zoomInButton.setAttribute('aria-disabled', 'true'));
      },
    }),
    Ge =
      ...
      Ne.extend({
        ...
        _addScales: function (t, e, i) {
          t.metric && (this._mScale = Xt('div', e, i)), t.imperial && (this._iScale = Xt('div', e, i));
        },
        _update: function () {
    ...
    qe = Ne.extend({
      ...
      onAdd: function (t) {
        for (var e in (((t.attributionControl = this)._container = Xt('div', 'leaflet-control-attribution')),
        Me(this._container),
        t._layers))
    ...
    He = I.extend({
      ...
      enable: function () {
        this._enabled || (ye(this._dragStartTarget, We, this._onDown, this), (this._enabled = !0));
      },
      disable: function () {
        this._enabled &&
          ...
          ne(this._element, 'leaflet-zoom-anim') ||
            (t.touches && 1 !== t.touches.length
              ...
              : He._dragging ||
                ...
                ((He._dragging = this)._preventOutline && me(this._element),
                pe(),
                Gt(),
                this._moving ||
                  (this.fire('down'),
      ...
      _onMove: function (t) {
        ...
        this._enabled &&
          (t.touches && 1 < t.touches.length
            ? (this._moved = !0)
            : (!(e = new k((e = t.touches && 1 === t.touches.length ? t.touches[0] : t).clientX, e.clientY)._subtract(this._startPoint))
                .x &&
                !e.y) ||
      ...
      finishDrag: function (t) {
        se(document.body, 'leaflet-dragging'),
          this._lastTarget && (se(this._lastTarget, 'leaflet-drag-target'), (this._lastTarget = null)),
      ...
      (o[0] = o[n - 1] = 1),
        (function t(e, i, n, o, s) {
          var r,
            ...
            h,
            l = 0;
          for (a = o + 1; a <= s - 1; a++) l < (h = Xe(e[a], e[o], e[s], !0)) && ((r = a), (l = h));
  ...
  function Je(t, e, i, n, o) {
    ...
    for (Fe = l; ; ) {
      if (!(h | l)) return [t, e];
      if (h & l) return !1;
      (a = Qe((r = Ye(t, e, (s = h || l), i, o)), i)), s === h ? ((t = r), (h = a)) : ((e = r), (l = a));
    }
  }
  ...
  function ti(t) {
    return console.warn('Deprecated use of _flat, please use L.LineUtil.isFlat instead.'), $e(t);
  }
  function ei(t, e) {
    var i, n, o, s, r;
    if (!t || 0 === t.length) throw new Error('latlngs not passed');
    $e(t) || (console.warn('latlngs are not flat! Only the first ring will be used'), (t = t[0]));
    var a,
      h = [];
  ...
  function ii(t, e, i) {
    for (var n, o, s, r, a, h, l, u = [1, 4, 2, 8], c = 0, d = t.length; c < d; c++) t[c]._code = Qe(t[c], e);
    for (s = 0; s < 4; s++) {
      for (h = u[s], n = [], c = 0, o = (d = t.length) - 1; c < d; o = c++)
        (r = t[c]),
          (a = t[o]),
          r._code & h
            ? a._code & h || (((l = Ye(a, r, h, e, i))._code = Qe(l, e)), n.push(l))
            : (a._code & h && (((l = Ye(a, r, h, e, i))._code = Qe(l, e)), n.push(l)), n.push(r));
      t = n;
    }
    return t;
  }
  function ni(t, e) {
    ...
    for (var u = l.length, c = (s = r = 0), d = 0, p = u - 1; d < u; p = d++)
      (i = l[d]), (n = l[p]), (o = i.y * n.x - n.y * i.x), (s += (i.x + n.x) * o), (r += (i.y + n.y) * o), (c += 3 * o);
  ...
  (it = { __proto__: null, clipPolygon: ii, polygonCenter: ni }),
    ...
    (at = e({}, j, { code: 'EPSG:3395', projection: ot, transformation: W((rt = 0.5 / (Math.PI * ot.R)), 0.5, -rt, 0.5) }));
  var oi = e({}, j, { code: 'EPSG:4326', projection: nt, transformation: W(1 / 180, 1, -1 / 180, 0.5) }),
    si =
      ((ht = e({}, U, {
        projection: nt,
      ...
      Re.include({
        addLayer: function (t) {
          ...
          if (t._layerAdd)
            return (
              (e = r(t)),
              this._layers[e] ||
                (((this._layers[e] = t)._mapToAdd = this), t.beforeAdd && t.beforeAdd(this), this.whenReady(t._layerAdd, t)),
              this
            );
        ...
        _removeZoomLimit: function (t) {
          (t = r(t)), this._zoomBoundLayers[t] && (delete this._zoomBoundLayers[t], this._updateZoomLevels());
        },
    ...
    ai = A.extend({
      ...
      _setIconStyles: function (t, e) {
        var i = this.options,
          ...
          o = O(('shadow' === e && i.shadowAnchor) || i.iconAnchor || (n && n.divideBy(2, !0)));
      ...
      _getIconUrl: function (t) {
        return (Mt.retina && this.options[t + 'RetinaUrl']) || this.options[t + 'Url'];
      },
    }),
    hi = ai.extend({
      options: {
      ...
      _getIconUrl: function (t) {
        return (
          'string' != typeof hi.imagePath && (hi.imagePath = this._detectIconPath()),
          (this.options.imagePath || hi.imagePath) + ai.prototype._getIconUrl.call(this, t)
        );
      },
    ...
    li = $.extend({
      ...
      _adjustPan: function (t) {
        var e = this._marker,
          ...
          r = i.getPixelBounds(),
          a = i.getPixelOrigin();
        (a = B(r.min._subtract(a).add(o), r.max._subtract(a).subtract(o))).contains(s) ||
          ((o = O(
      ...
      _onDrag: function (t) {
        ...
        i && ce(i, n), (e._latlng = o), (t.latlng = o), (t.oldLatLng = this._oldLatLng), e.fire('move', t).fire('drag', t);
      },
    ...
    ui = lt.extend({
      ...
      _initIcon: function () {
        ...
        (t =
          ((t = e.icon.createIcon(this._icon)) !== this._icon &&
            (this._icon && this._removeIcon(), (n = !0), e.title && (t.title = e.title), 'IMG' === t.tagName && (t.alt = e.alt || '')),
          oe(t, i),
          ...
          e.icon.createShadow(this._shadow))) !== this._shadow && (this._removeShadow(), (o = !0)),
          t && (oe(t, i), (t.alt = '')),
          (this._shadow = t),
      ...
      _panOnFocus: function () {
        var t,
          ...
          i = this._map;
        i &&
          ((t = (e = this.options.icon.options).iconSize ? O(e.iconSize) : O(0, 0)),
    ...
    di = ci.extend({
      ...
      setStyle: function (t) {
        ...
        return ci.prototype.setStyle.call(this, t), this.setRadius(e), this;
      },
      _project: function () {
    ...
    pi = di.extend({
      initialize: function (t, i, n) {
        if ((p(this, (i = 'number' == typeof i ? e({}, n, { radius: i }) : i)), (this._latlng = N(t)), isNaN(this.options.radius)))
    ...
    _i = ci.extend({
      ...
      closestLayerPoint: function (t) {
        for (var e = 1 / 0, i = null, n = Xe, o = 0, s = this._parts.length; o < s; o++)
      ...
      getCenter: function () {
        if (this._map) return ei(this._defaultShape(), this._map.options.crs);
      ...
      _updateBounds: function () {
        ...
        this._rawPxBounds && (this._pxBounds = new Z([this._rawPxBounds.min.subtract(t), this._rawPxBounds.max.add(t)]));
      },
      ...
      _simplifyPoints: function () {
        for (var t = this._parts, e = this.options.smoothFactor, i = 0, n = t.length; i < n; i++) t[i] = Ve(t[i], e);
      },
      _update: function () {
      ...
      _containsPoint: function (t, e) {
        ...
        if (this._pxBounds && this._pxBounds.contains(t))
          for (i = 0, s = this._parts.length; i < s; i++)
            for (n = 0, o = (r = (a = this._parts[i]).length) - 1; n < r; o = n++) if ((e || 0 !== n) && Ke(t, a[o], a[n]) <= h) return !0;
        return !1;
      },
    });
  _i._flat = ti;
  var mi = _i.extend({
      ...
      getCenter: function () {
        if (this._map) return ni(this._defaultShape(), this._map.options.crs);
        throw new Error('Must add layer to map before using getCenter()');
      },
      _convertLatLngs: function (t) {
        var e = (t = _i.prototype._convertLatLngs.call(this, t)).length;
        return 2 <= e && t[0] instanceof F && t[0].equals(t[e - 1]) && t.pop(), t;
      },
      _setLatLngs: function (t) {
        _i.prototype._setLatLngs.call(this, t), $e(this._latlngs) && (this._latlngs = [this._latlngs]);
      },
      _defaultShape: function () {
        return ($e(this._latlngs[0]) ? this._latlngs : this._latlngs[0])[0];
      },
      _clipPoints: function () {
        var t = this._renderer._bounds,
        ...
        if (((this._parts = []), this._pxBounds && this._pxBounds.intersects(t)))
          if (this.options.noClip) this._parts = this._rings;
          else for (var i, n = 0, o = this._rings.length; n < o; n++) (i = ii(this._rings[n], t, !0)).length && this._parts.push(i);
      },
      _updatePath: function () {
  ...
  function gi(t, e) {
    ...
    switch (r.type) {
      ...
      case 'MultiPoint':
        for (o = 0, s = a.length; o < s; o++) (i = u(a[o])), h.push(vi(l, t, i, e));
        return new ri(h);
      case 'LineString':
      ...
      case 'Polygon':
      case 'MultiPolygon':
        return (n = xi(a, 'Polygon' === r.type ? 1 : 2, u)), new mi(n, e);
      case 'GeometryCollection':
        for (o = 0, s = r.geometries.length; o < s; o++) {
          var c = gi({ geometry: r.geometries[o], type: 'Feature', properties: t.properties }, e);
          c && h.push(c);
        }
        return new ri(h);
  ...
  function xi(t, e, i) {
    for (var n, o = [], s = 0, r = t.length; s < r; s++) (n = e ? xi(t[s], e - 1, i) : (i || yi)(t[s])), o.push(n);
    return o;
  }
  function bi(t, e) {
    return void 0 !== (t = N(t)).alt ? [u(t.lng, e), u(t.lat, e), u(t.alt, e)] : [u(t.lng, e), u(t.lat, e)];
  }
  function wi(t, e, i, n) {
    for (var o = [], s = 0, r = t.length; s < r; s++) o.push(e ? wi(t[s], $e(t[s]) ? 0 : e - 1, i, n) : bi(t[s], n));
  ...
  (ut = {
    toGeoJSON: function (t) {
      return Li(this, { type: 'Point', coordinates: bi(this.getLatLng(), t) });
    },
  }),
    ui.include(ut),
    pi.include(ut),
    ...
    _i.include({
      toGeoJSON: function (t) {
        ...
        return Li(this, { type: (e ? 'Multi' : '') + 'LineString', coordinates: wi(this._latlngs, e ? 1 : 0, !1, t) });
      },
    }),
    mi.include({
      toGeoJSON: function (t) {
        ...
        return Li(this, { type: (i ? 'Multi' : '') + 'Polygon', coordinates: (t = e ? t : [t]) });
      },
    }),
    si.include({
      ...
      toGeoJSON: function (t) {
        var e,
          i,
          n = this.feature && this.feature.geometry && this.feature.geometry.type;
        return 'MultiPoint' === n
          ? this.toMultiPoint(t)
          : ((e = 'GeometryCollection' === n),
            ...
            this.eachLayer(function (n) {
              n.toGeoJSON &&
                ((n = n.toGeoJSON(t)),
                e ? i.push(n.geometry) : 'FeatureCollection' === (n = Pi(n)).type ? i.push.apply(i, n.features) : i.push(n));
            }),
            e ? Li(this, { geometries: i, type: 'GeometryCollection' }) : { type: 'FeatureCollection', features: i });
      },
    });
  ct = Ti;
  var Si = lt.extend({
      ...
      onAdd: function () {
        this._image || (this._initImage(), this.options.opacity < 1 && this._updateOpacity()),
          this.options.interactive && (oe(this._image, 'leaflet-interactive'), this.addInteractiveTarget(this._image)),
    ...
    Ai = lt.extend({
      ...
      initialize: function (t, e) {
        t && (t instanceof L.LatLng || g(t)) ? ((this._latlng = N(t)), p(this, e)) : (p(this, t), (this._source = e)),
      ...
      toggle: function (t) {
        return (
          this._map ? this.close() : (arguments.length ? (this._source = t) : (t = this._source), this._prepareOpen(), this.openOn(t._map)),
          this
        );
      },
      onAdd: function (t) {
        (this._zoomAnimated = t._zoomAnimated),
          ...
          this.bringToFront(),
          this.options.interactive && (oe(this._container, 'leaflet-interactive'), this.addInteractiveTarget(this._container));
      },
      onRemove: function (t) {
        t._fadeAnimated
          ? (he(this._container, 0), (this._removeTimeout = setTimeout(o($t, void 0, this._container), 200)))
          : $t(this._container),
          this.options.interactive && (se(this._container, 'leaflet-interactive'), this.removeInteractiveTarget(this._container));
      },
      getLatLng: function () {
        return this._latlng;
      },
      ...
      Ai.extend({
        ...
        onAdd: function (t) {
          Ai.prototype.onAdd.call(this, t),
            ...
            this._source &&
              (this._source.fire('popupopen', { popup: this }, !0), this._source instanceof ci || this._source.on('preclick', Se));
        },
        onRemove: function (t) {
          Ai.prototype.onRemove.call(this, t),
            t.fire('popupclose', { popup: this }),
            this._source &&
              (this._source.fire('popupclose', { popup: this }, !0), this._source instanceof ci || this._source.off('preclick', Se));
        },
        getEvents: function () {
        ...
        _initLayout: function () {
          var t = 'leaflet-popup',
            e = (this._container = Xt('div', t + ' ' + (this.options.className || '') + ' leaflet-zoom-animated')),
          ...
          (this._contentNode = Xt('div', t + '-content', i)),
            ...
            this.options.closeButton &&
              ((i = this._closeButton = Xt('a', t + '-close-button', e)).setAttribute('role', 'button'),
        ...
        _updateLayout: function () {
          var t = this._contentNode,
            ...
            n =
              ...
              (i =
                ((i = Math.max(i, this.options.minWidth)), (e.width = i + 1 + 'px'), (e.whiteSpace = ''), (e.height = ''), t.offsetHeight)),
              this.options.maxHeight);
          (n && n < i ? ((e.height = n + 'px'), oe) : se)(t, 'leaflet-popup-scrolled'),
        ...
        _adjustPan: function (t) {
          ...
          this.options.autoPan &&
            ...
            (n = new k(this._containerLeft, -i - this._containerBottom))._add(de(this._container)),
            ...
            (a || h) && e.fire('autopanstart').panBy([a, h], { animate: t && 'moveend' === t.type }));
        },
        _getAnchor: function () {
    ...
    ki =
      ...
      ai.extend({
        ...
        createIcon: function (t) {
          ...
          var e = this.options;
          return (
            e.html instanceof Element ? (te(t), t.appendChild(e.html)) : (t.innerHTML = !1 !== e.html ? e.html : ''),
            e.bgPos && ((e = O(e.bgPos)), (t.style.backgroundPosition = -e.x + 'px ' + -e.y + 'px')),
  ...
  var Ei = lt.extend({
      ...
      bringToFront: function () {
        return this._map && (ee(this._container), this._setAutoZIndex(Math.max)), this;
      },
      bringToBack: function () {
      ...
      getEvents: function () {
        ...
        return (
          this.options.updateWhenIdle ||
            (this._onMove || (this._onMove = a(this._onMoveEnd, this.options.updateInterval, this)), (t.move = this._onMove)),
      ...
      _updateOpacity: function () {
        if (this._map && !Mt.ielt9) {
          ...
          n && !this._noPrune && this._pruneTiles(), i && (C(this._fadeFrame), (this._fadeFrame = S(this._updateOpacity, this)));
        }
      },
      _onOpaqueTile: l,
      _initContainer: function () {
        this._container ||
          ((this._container = Xt('div', 'leaflet-layer ' + (this.options.className || ''))),
          this._updateZIndex(),
      ...
      _updateLevels: function () {
        ...
        if (void 0 !== t) {
          ...
          return (
            n ||
              (((n = this._levels[t] = {}).el = Xt('div', 'leaflet-tile-container leaflet-zoom-animated', this._container)),
              (n.el.style.zIndex = e),
      ...
      _retainParent: function (t, e, i, n) {
        i -= 1;
        var o = (((o = new k(+(t = Math.floor(t / 2)), +(e = Math.floor(e / 2)))).z = i), this._tileCoordsToKey(o));
      ...
      _getTiledPixelBounds: function (t) {
        var e = (i = this._map)._animatingZoom ? Math.max(i._animateToZoom, i.getZoom()) : i.getZoom(),
          i = ((e = i.getZoomScale(e, this._tileZoom)), (t = i.project(t, this._tileZoom).floor()), i.getSize().divideBy(2 * e));
        ...
        if ((n = this._map)) {
          ...
          if ((void 0 === t && (t = n.getCenter()), void 0 !== this._tileZoom)) {
            var i,
              ...
              s = o.getCenter(),
              r = [],
              a = ((n = this.options.keepBuffer), new Z(o.getBottomLeft().subtract([n, -n]), o.getTopRight().add([n, -n])));
      ...
      _isValidTile: function (t) {
        ...
        return !this.options.bounds || ((e = this._tileCoordsToBounds(t)), D(this.options.bounds).overlaps(e));
      },
      ...
      _tileCoordsToBounds: function (t) {
        return (t = new R((t = this._tileCoordsToNwSe(t))[0], t[1])), this.options.noWrap ? t : this._map.wrapLatLngBounds(t);
      },
      ...
      _tileReady: function (t, e, i) {
        ...
        (i = this._tiles[n]) &&
          ...
          this._map._fadeAnimated
            ? (he(i.el, 0), C(this._fadeFrame), (this._fadeFrame = S(this._updateOpacity, this)))
            : ((i.active = !0), this._pruneTiles()),
          e || (oe(i.el, 'leaflet-tile-loaded'), this.fire('tileload', { tile: i.el, coords: t })),
          this._noTilesToLoad() &&
            ((this._loading = !1),
            this.fire('load'),
            Mt.ielt9 || !this._map._fadeAnimated ? S(this._pruneTiles, this) : setTimeout(o(this._pruneTiles, this), 250)));
      },
    ...
    Oi = Ei.extend({
      ...
      getTileUrl: function (t) {
        var i = { r: Mt.retina ? '@2x' : '', s: this._getSubdomain(t), x: t.x, y: t.y, z: this._getZoomForUrl() };
        return (
          this._map &&
            !this._map.options.crs.infinite &&
            ((t = this._globalTileRange.max.y - t.y), this.options.tms && (i.y = t), (i['-y'] = t)),
      ...
      _abortLoading: function () {
        ...
        for (t in this._tiles)
          this._tiles[t].coords.z !== this._tileZoom &&
            ...
            (i.onerror = l),
            i.complete ||
              ((i.src = y), (e = this._tiles[t].coords), $t(i), delete this._tiles[t], this.fire('tileabort', { tile: i, coords: e })));
      },
      _removeTile: function (t) {
        var e = this._tiles[t];
        if (e) return e.el.setAttribute('src', y), Ei.prototype._removeTile.call(this, t);
      },
      _tileReady: function (t, e, i) {
        if (this._map && (!i || i.getAttribute('src') !== y)) return Ei.prototype._tileReady.call(this, t, e, i);
      },
    });
  function Zi(t, e) {
    return new Oi(t, e);
  ...
  var Bi = Oi.extend({
    ...
    getTileUrl: function (t) {
      var e = this._tileCoordsToNwSe(t),
        i = ((e = (i = B((i = this._crs).project(e[0]), i.project(e[1]))).min), i.max);
      e = (1.3 <= this._wmsVersion && this._crs === oi ? [e.y, e.x, i.y, i.x] : [e.x, e.y, i.x, i.y]).join(',');
      return (
  ...
  var Ri = lt.extend({
      ...
      onAdd: function () {
        this._container || (this._initContainer(), this._zoomAnimated && oe(this._container, 'leaflet-zoom-animated')),
          this.getPane().appendChild(this._container),
          this._update(),
    ...
    Di = Ri.extend({
      ...
      _destroyContainer: function () {
        C(this._redrawRequest), delete this._ctx, $t(this._container), be(this._container), delete this._container;
      },
      _updatePaths: function () {
      ...
      _initPath: function (t) {
        this._updateDashArray(t),
          (t = (this._layers[r(t)] = t)._order = { layer: t, prev: this._drawLast, next: null }),
      ...
      _handleMouseHover: function (t, e) {
        if (!this._mouseHoverThrottled) {
          ...
          n !== this._hoveredLayer &&
            ...
            n && (oe(this._container, 'leaflet-interactive'), this._fireEvent([n], t, 'mouseover'), (this._hoveredLayer = n))),
  ...
  var Ni = (function () {
      ...
      ((dt = {
        ...
        _updateStyle: function (t) {
          ...
          (o.stroked = !!n.stroke),
            ...
            n.fill
              ? ((i = i || (t._fill = Ni('fill'))), o.appendChild(i), (i.color = n.fillColor || n.color), (i.opacity = n.fillOpacity))
    ...
    ji = Ri.extend({
      ...
      _destroyContainer: function () {
        $t(this._container), be(this._container), delete this._container, delete this._rootGroup, delete this._svgSize;
      },
      _update: function () {
        var t, e, i;
        (this._map._animatingZoom && this._bounds) ||
      ...
      _removePath: function (t) {
        $t(t._path), t.removeInteractiveTarget(t._path), delete this._layers[r(t)];
      },
      _updatePath: function (t) {
  ...
  (Y = $.extend({
    ...
    _onMouseDown: function (t) {
      ...
      this._clearDeferredResetState(),
        ...
        ye(document, { contextmenu: ze, mousemove: this._onMouseMove, mouseup: this._onMouseUp, keydown: this._onKeyDown }, this);
    },
    _onMouseMove: function (t) {
      this._moved ||
        ((this._moved = !0),
      ...
      ce(this._box, t.min), (this._box.style.width = e.x + 'px'), (this._box.style.height = e.y + 'px');
    },
    _finish: function () {
      this._moved && ($t(this._box), se(this._container, 'leaflet-crosshair')),
        qt(),
        _e(),
        be(document, { contextmenu: ze, mousemove: this._onMouseMove, mouseup: this._onMouseUp, keydown: this._onKeyDown }, this);
    },
  ...
  var Wi =
    ...
    Hi =
        ...
        $.extend({
          ...
          addHooks: function () {
            ...
            t.tabIndex <= 0 && (t.tabIndex = '0'),
              ye(t, { focus: this._onFocus, blur: this._onBlur, mousedown: this._onMouseDown }, this),
              this._map.on({ focus: this._addHooks, blur: this._removeHooks }, this);
          },
          removeHooks: function () {
            this._removeHooks(),
              be(this._map._container, { focus: this._onFocus, blur: this._onBlur, mousedown: this._onMouseDown }, this),
      ...
      (mt =
        ...
        Re.mergeOptions({ scrollWheelZoom: !0, wheelDebounceTime: 40, wheelPxPerZoomLevel: 60 }),
        $.extend({
          addHooks: function () {
            ye(this._map._container, 'wheel', this._onWheelScroll, this), (this._delta = 0);
          },
          removeHooks: function () {
          ...
          _onWheelScroll: function (t) {
            ...
            clearTimeout(this._timer), (this._timer = setTimeout(o(this._performZoom, this), e)), ze(t);
          },
      ...
      (ft =
        ...
        Re.mergeOptions({ tapHold: Mt.touchNative && Mt.safari && Mt.mobile, tapTolerance: 15 }),
        $.extend({
          addHooks: function () {
          ...
          _cancelClickPrevent: function t() {
            be(document, 'touchend', Ae), be(document, 'touchend touchcancel', t);
          },
          _cancel: function () {
            clearTimeout(this._holdTimeout),
      ...
      (gt =
        ...
        Re.mergeOptions({ touchZoom: Mt.touch, bounceAtZoomLimits: !0 }),
        $.extend({
          addHooks: function () {
            oe(this._map._container, 'leaflet-touch-zoom'), ye(this._map._container, 'touchstart', this._onTouchStart, this);
          },
          removeHooks: function () {
            se(this._map._container, 'leaflet-touch-zoom'), be(this._map._container, 'touchstart', this._onTouchStart, this);
          },
            ...
            if (t.touches && 2 === t.touches.length && this._zooming) {
              ...
              if (
                ...
                !e.options.bounceAtZoomLimits &&
                  ((this._zoom < e.getMinZoom() && s < 1) || (this._zoom > e.getMaxZoom() && 1 < s)) &&
                  (this._zoom = e._limitZoom(this._zoom)),
                'center' === e.options.touchZoom)
              ) {
                if (((this._center = this._startLatLng), 1 == s)) return;
              } else {
                if (((i = i._add(n)._divideBy(2)._subtract(this._centerPoint)), 1 == s && 0 === i.x && 0 === i.y)) return;
                this._center = e.unproject(e.project(this._pinchStartLatLng, this._zoom).subtract(i), this._zoom);
              }
              this._moved || (e._moveStart(!0, !1), (this._moved = !0)),
                C(this._animRequest),
                (n = o(e._move, e, this._center, this._zoom, { pinch: !0, round: !1 }, void 0)),
  ...
  (function (t, e) {
    'object' == typeof exports && 'undefined' != typeof module
      ...
      : e((((t = 'undefined' != typeof globalThis ? globalThis : t || self).L = t.L || {}), (t.L.esri = {})), t.L);
  })(this, function (t, e) {
    'use strict';
    ...
    function h(t, i) {
      ...
      return (
        (n.onerror = function (o) {
          (n.onreadystatechange = e.Util.falseFn), t.call(i, { error: { code: 500, message: 'XMLHttpRequest error' } }, null);
        }),
    ...
    function u(t, e, i, n) {
      ...
      return (
        o.open('GET', t + '?' + a(e), !0),
        null != n && void 0 !== n.options && ((o.timeout = n.options.timeout), n.options.withCredentials && (o.withCredentials = !0)),
        o.send(null),
        o
      );
    }
    function c(t, e, i, n) {
      ...
      if (
        (l <= 2e3 && o.cors
          ...
          : l > 2e3 &&
            o.cors &&
            (r.open('POST', t), r.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded; charset=UTF-8')),
        null != n && void 0 !== n.options && ((r.timeout = n.options.timeout), n.options.withCredentials && (r.withCredentials = !0)),
        l <= 2e3 && o.cors)
      )
        r.send(null);
      else {
      ...
      (i.callback = 'window._EsriLeafletCallbacks.' + s),
        (window._EsriLeafletCallbacks[s] = function (t) {
          if (!0 !== window._EsriLeafletCallbacks[s]) {
            ...
            '[object Object]' !== i &&
              '[object Array]' !== i &&
              ((e = { error: { code: 500, message: 'Expected array or object as JSONP response' } }), (t = null)),
      ...
      return (
        ...
        (h.onerror = function (t) {
          t &&
            ...
            (n.call(o, { error: { code: 500, message: 'An unknown error occurred' } }), (window._EsriLeafletCallbacks[s] = !0));
        }),
    ...
    var m = { request: c, get: p, post: l },
      ...
      g = function (t, e) {
        for (var i = 0; i < t.length - 1; i++) for (var n = 0; n < e.length - 1; n++) if (f(t[i], t[i + 1], e[n], e[n + 1])) return !0;
        return !1;
      },
      v = function (t) {
        return (
        ...
        var i = g(t, e),
          n = (function (t, e) {
            for (var i = !1, n = -1, o = t.length, s = o - 1; ++n < o; s = n)
              ((t[n][1] <= e[1] && e[1] < t[s][1]) || (t[s][1] <= e[1] && e[1] < t[n][1])) &&
                e[0] < ((t[s][0] - t[n][0]) * (e[1] - t[n][1])) / (t[s][1] - t[n][1]) + t[n][0] &&
                (i = !i);
            return i;
          })(t, e[0]);
        return !(i || !n);
      ...
      w = function t(e, i) {
        ...
        if (
          ('number' == typeof e.x &&
            'number' == typeof e.y &&
            ((n.type = 'Point'), (n.coordinates = [e.x, e.y]), 'number' == typeof e.z && n.coordinates.push(e.z)),
          e.points && ((n.type = 'MultiPoint'), (n.coordinates = e.points.slice(0))),
          e.paths &&
            (1 === e.paths.length
              ? ((n.type = 'LineString'), (n.coordinates = e.paths[0].slice(0)))
              : ((n.type = 'MultiLineString'), (n.coordinates = e.paths.slice(0)))),
          e.rings &&
            (n = (function (t) {
              ...
              return 1 === o.length ? { type: 'Polygon', coordinates: o[0] } : { type: 'MultiPolygon', coordinates: o };
            })(e.rings.slice(0))),
        ...
        return (
          ...
          e.spatialReference &&
            ...
            console.warn('Object converted in non-standard crs - ' + JSON.stringify(e.spatialReference)),
          n
        );
      },
      L = function (t) {
      ...
      P = function t(e, i) {
        ...
        switch (e.type) {
          case 'Point':
            (s.x = e.coordinates[0]), (s.y = e.coordinates[1]), e.coordinates[2] && (s.z = e.coordinates[2]), (s.spatialReference = o);
            break;
          case 'MultiPoint':
            (s.points = e.coordinates.slice(0)), e.coordinates[0][2] && (s.hasZ = !0), (s.spatialReference = o);
            break;
          case 'LineString':
            (s.paths = [e.coordinates.slice(0)]), e.coordinates[0][2] && (s.hasZ = !0), (s.spatialReference = o);
            break;
          case 'MultiLineString':
            (s.paths = e.coordinates.slice(0)), e.coordinates[0][0][2] && (s.hasZ = !0), (s.spatialReference = o);
            break;
          case 'Polygon':
            (s.rings = L(e.coordinates.slice(0))), e.coordinates[0][0][2] && (s.hasZ = !0), (s.spatialReference = o);
            break;
          case 'MultiPolygon':
            (s.rings = (function (t) {
      ...
      T = '<a href="http://leafletjs.com" title="A JS library for interactive maps">Leaflet</a>';
    /* @preserve
    ...
    function F(t) {
      if (t.attributionControl) {
        if (
          (t.attributionControl._esriAttributionLayerCount || (t.attributionControl._esriAttributionLayerCount = 0),
          ...
          if (!t.attributionControl._esriAttributionAddedOnce) {
            ...
            (n.type = 'text/css'),
              ...
              t.on('resize', function (e) {
                t.attributionControl && (t.attributionControl._container.style.maxWidth = D(e.target));
              }),
              (t.attributionControl._esriAttributionAddedOnce = !0);
          }
          t.attributionControl.setPrefix(T + ' | Powered by <a href="https://www.esri.com">Esri</a>'),
    ...
    function N(t) {
      t.attributionControl &&
        (t.attributionControl._esriAttributionLayerCount &&
          ...
          e.DomUtil.removeClass(t.attributionControl._container, 'esri-truncated-attribution:hover'),
          e.DomUtil.removeClass(t.attributionControl._container, 'esri-truncated-attribution')),
        (t.attributionControl._esriAttributionLayerCount = t.attributionControl._esriAttributionLayerCount - 1));
    }
    function U(t) {
      ...
      return t instanceof e.LatLngBounds
        ...
        : (t.getLatLng && (t = t.getLatLng()),
          ...
          t instanceof e.GeoJSON && ((t = t.getLayers()[0].feature.geometry), (i.geometry = S(t)), (i.geometryType = R(t.type))),
    ...
    function G(t) {
      ...
      if (i && i.attributionControl) {
        ...
        if (o && n) {
          for (
            var s = '', r = i.getBounds(), a = e.latLngBounds(r.getSouthWest().wrap(), r.getNorthEast().wrap()), h = i.getZoom(), l = 0;
            l < n.length;
            l++
          ) {
            var u = n[l],
          ...
          (s = s.substr(2)), (o.innerHTML = s), (o.style.maxWidth = D(i)), i.fire('attributionupdated', { attribution: s });
        }
      }
    }
    var q = {
      ...
      W = e.Class.extend({
        ...
        request: function (t, i) {
          return (
            this.options.requestParams && e.Util.extend(this.params, this.options.requestParams),
        ...
        _request: function (t, e, i, n, o) {
          ...
          return ('get' !== t && 'request' !== t) || this.options.useCors ? m[t](s, i, n, o) : m.get.JSONP(s, i, n, o);
        },
      }),
      H = W.extend({
        setters: {
        ...
        run: function (t, e) {
          return (
            this._cleanParams(),
            this.options.isModern || (B(this.options.url) && void 0 === this.options.isModern)
        ...
        bounds: function (t, e) {
          return (
            ...
            this.request(function (i, n) {
              n && n.extent && M(n.extent) ? t.call(e, i, M(n.extent), n) : ((i = { message: 'Invalid Bounds' }), t.call(e, i, null, n));
            }, e)
          );
        },
        distinct: function () {
        ...
        _trapSQLerrors: function (t) {
          t &&
            '400' === t.code &&
            _('one common syntax error in query requests is encasing string values in double quotes instead of single quotes');
        },
    ...
    var $ = Y.extend({
      ...
      at: function (t) {
        return (
          (t = e.latLng(t)),
          (this.params.geometry = JSON.stringify({ x: t.lng, y: t.lat, spatialReference: { wkid: 4326 } })),
          (this.params.geometryType = 'esriGeometryPoint'),
          this
        );
      },
      ...
      _responseToGeoJSON: function (t) {
        ...
        if (
          (t.properties && t.properties.Values && (o.pixel.properties.values = t.properties.Values),
          i && i.features && ((o.catalogItems = E(i)), n && n.length === o.catalogItems.features.length))
        )
          for (var s = n.length - 1; s >= 0; s--) o.catalogItems.features[s].properties.catalogItemVisibility = n[s];
        return o;
      },
    });
    function tt(t) {
    ...
    var et = e.Evented.extend({
        ...
        _request: function (t, i, n, o, s) {
          this.fire('requeststart', { url: this.options.url + i, params: n, method: t }, !0);
          var r = this._createServiceCallback(t, i, n, o, s);
          if (
            (this.options.token && (n.token = this.options.token),
            this.options.requestParams && e.Util.extend(n, this.options.requestParams),
            !this._authenticating)
          ) {
            var a = this.options.proxy ? this.options.proxy + '?' + this.options.url + i : this.options.url + i;
            return ('get' !== t && 'request' !== t) || this.options.useCors ? m[t](a, n, r, s) : m.get.JSONP(a, n, r, s);
          }
        ...
        _createServiceCallback: function (t, i, n, o, s) {
          return e.Util.bind(function (r, a) {
            !r ||
              ...
              o.call(s, r, a),
              r
                ? this.fire('requesterror', { url: this.options.url + i, params: n, message: r.message, code: r.code, method: t }, !0)
                : this.fire('requestsuccess', { url: this.options.url + i, params: n, response: a, method: t }, !0),
              this.fire('requestend', { url: this.options.url + i, params: n, method: t }, !0);
          }, this);
        },
        _runQueue: function () {
    ...
    var rt = et.extend({
      ...
      addFeatures: function (t, e, i) {
        for (var n = t.features ? t.features : [t], o = n.length - 1; o >= 0; o--) delete n[o].id;
        return (
          (t = S(t)),
          (t = n.length > 1 ? t : [t]),
          this.post(
            ...
            { features: t },
            function (t, n) {
              var o = n && n.addResults ? (n.addResults.length > 1 ? n.addResults : n.addResults[0]) : void 0;
      ...
      updateFeatures: function (t, e, i) {
        ...
        return (
          ...
          this.post(
            ...
            { features: t },
            function (t, n) {
              var o = n && n.updateResults ? (n.updateResults.length > 1 ? n.updateResults : n.updateResults[0]) : void 0;
      ...
      deleteFeatures: function (t, e, i) {
        return this.post(
          ...
          { objectIds: t },
          function (t, n) {
            var o = n && n.deleteResults ? (n.deleteResults.length > 1 ? n.deleteResults : n.deleteResults[0]) : void 0;
    ...
    var ht = 'https:' !== window.location.protocol ? 'http:' : 'https:',
      lt = e.TileLayer.extend({
        statics: {
          TILES: {
            Streets: {
              urlTemplate: ht + '//{s}.arcgisonline.com/ArcGIS/rest/services/World_Street_Map/MapServer/tile/{z}/{y}/{x}',
              options: {
                minZoom: 1,
                maxZoom: 19,
            ...
            Topographic: {
              urlTemplate: ht + '//{s}.arcgisonline.com/ArcGIS/rest/services/World_Topo_Map/MapServer/tile/{z}/{y}/{x}',
              options: {
                minZoom: 1,
                maxZoom: 19,
                subdomains: ['server', 'services'],
            ...
            Oceans: {
              urlTemplate: ht + '//{s}.arcgisonline.com/arcgis/rest/services/Ocean/World_Ocean_Base/MapServer/tile/{z}/{y}/{x}',
              options: {
                minZoom: 1,
                maxZoom: 16,
                subdomains: ['server', 'services'],
            ...
            OceansLabels: {
              urlTemplate: ht + '//{s}.arcgisonline.com/arcgis/rest/services/Ocean/World_Ocean_Reference/MapServer/tile/{z}/{y}/{x}',
              options: {
                minZoom: 1,
                maxZoom: 16,
                subdomains: ['server', 'services'],
            ...
            NationalGeographic: {
              urlTemplate: ht + '//{s}.arcgisonline.com/ArcGIS/rest/services/NatGeo_World_Map/MapServer/tile/{z}/{y}/{x}',
              options: {
                minZoom: 1,
                maxZoom: 16,
                subdomains: ['server', 'services'],
            ...
            DarkGray: {
              urlTemplate: ht + '//{s}.arcgisonline.com/ArcGIS/rest/services/Canvas/World_Dark_Gray_Base/MapServer/tile/{z}/{y}/{x}',
              options: {
                minZoom: 1,
                maxZoom: 16,
                subdomains: ['server', 'services'],
            ...
            DarkGrayLabels: {
              urlTemplate: ht + '//{s}.arcgisonline.com/ArcGIS/rest/services/Canvas/World_Dark_Gray_Reference/MapServer/tile/{z}/{y}/{x}',
              options: {
                minZoom: 1,
                maxZoom: 16,
                subdomains: ['server', 'services'],
            ...
            Gray: {
              urlTemplate: ht + '//{s}.arcgisonline.com/ArcGIS/rest/services/Canvas/World_Light_Gray_Base/MapServer/tile/{z}/{y}/{x}',
              options: {
                minZoom: 1,
                maxZoom: 16,
                subdomains: ['server', 'services'],
            ...
            GrayLabels: {
              urlTemplate: ht + '//{s}.arcgisonline.com/ArcGIS/rest/services/Canvas/World_Light_Gray_Reference/MapServer/tile/{z}/{y}/{x}',
              options: {
                minZoom: 1,
                maxZoom: 16,
                subdomains: ['server', 'services'],
            ...
            Imagery: {
              urlTemplate: ht + '//{s}.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}',
              options: {
                minZoom: 1,
                maxZoom: 19,
                subdomains: ['server', 'services'],
            ...
            ImageryLabels: {
              urlTemplate:
                ht + '//{s}.arcgisonline.com/ArcGIS/rest/services/Reference/World_Boundaries_and_Places/MapServer/tile/{z}/{y}/{x}',
              options: {
                minZoom: 1,
                maxZoom: 19,
                subdomains: ['server', 'services'],
            ...
            ImageryTransportation: {
              urlTemplate: ht + '//{s}.arcgisonline.com/ArcGIS/rest/services/Reference/World_Transportation/MapServer/tile/{z}/{y}/{x}',
              options: {
                minZoom: 1,
                maxZoom: 19,
                subdomains: ['server', 'services'],
            ...
            ShadedRelief: {
              urlTemplate: ht + '//{s}.arcgisonline.com/ArcGIS/rest/services/World_Shaded_Relief/MapServer/tile/{z}/{y}/{x}',
            ...
            Terrain: {
              urlTemplate: ht + '//{s}.arcgisonline.com/ArcGIS/rest/services/World_Terrain_Base/MapServer/tile/{z}/{y}/{x}',
              options: { minZoom: 1, maxZoom: 13, subdomains: ['server', 'services'], attribution: 'USGS, NOAA' },
            },
            TerrainLabels: {
              urlTemplate: ht + '//{s}.arcgisonline.com/ArcGIS/rest/services/Reference/World_Reference_Overlay/MapServer/tile/{z}/{y}/{x}',
              options: {
                minZoom: 1,
                maxZoom: 13,
                subdomains: ['server', 'services'],
            ...
            USATopo: {
              urlTemplate: ht + '//{s}.arcgisonline.com/ArcGIS/rest/services/USA_Topo_Maps/MapServer/tile/{z}/{y}/{x}',
              options: {
                minZoom: 1,
                maxZoom: 15,
                subdomains: ['server', 'services'],
            ...
            ImageryClarity: {
              urlTemplate: ht + '//clarity.maptiles.arcgis.com/arcgis/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}',
              options: {
                minZoom: 1,
                maxZoom: 19,
                attribution:
            ...
            Physical: {
              urlTemplate: ht + '//{s}.arcgisonline.com/arcgis/rest/services/World_Physical_Map/MapServer/tile/{z}/{y}/{x}',
              options: { minZoom: 1, maxZoom: 8, subdomains: ['server', 'services'], attribution: 'U.S. National Park Service' },
            },
            ImageryFirefly: {
              urlTemplate: ht + '//fly.maptiles.arcgis.com/arcgis/rest/services/World_Imagery_Firefly/MapServer/tile/{z}/{y}/{x}',
              options: {
                minZoom: 1,
                maxZoom: 19,
                attribution:
        ...
        initialize: function (t, i) {
          ...
          e.Util.setOptions(this, o),
            ...
            this.options.token && -1 === n.urlTemplate.indexOf('token=') && (n.urlTemplate += '?token=' + this.options.token),
            this.options.proxy && (n.urlTemplate = this.options.proxy + '?' + n.urlTemplate),
            e.TileLayer.prototype.initialize.call(this, n.urlTemplate, o);
        },
        onAdd: function (t) {
          F(t),
            'esri-labels' === this.options.pane && this._initPane(),
            this.options.attributionUrl && j((this.options.proxy ? this.options.proxy + '?' : '') + this.options.attributionUrl, t),
            t.on('moveend', G),
            e.TileLayer.prototype.onAdd.call(this, t);
        },
        onRemove: function (t) {
          N(t), t.off('moveend', G), e.TileLayer.prototype.onRemove.call(this, t);
        },
        _initPane: function () {
      ...
      ut = e.TileLayer.extend({
        ...
        initialize: function (t) {
          (t = Z((t = e.Util.setOptions(this, t)))),
            (this.tileUrl =
              ...
              t.url +
              'tile/{z}/{y}/{x}' +
              (t.requestParams && Object.keys(t.requestParams).length > 0 ? e.Util.getParamString(t.requestParams) : '')),
            -1 !== t.url.indexOf('{s}') && t.subdomains && (t.url = t.url.replace('{s}', t.subdomains[0])),
            (this.service = nt(t)),
            this.service.addEventParent(this),
            new RegExp(/tiles.arcgis(online)?\.com/g).test(t.url) &&
              ((this.tileUrl = this.tileUrl.replace('://tiles', '://tiles{s}')), (t.subdomains = ['1', '2', '3', '4'])),
        ...
        createTile: function (t, i) {
          ...
          return (
            ...
            e.DomEvent.on(n, 'error', e.Util.bind(this._tileOnError, this, i, n)),
                ...
                if (!i && n.spatialReference) {
                  ...
                  if (
                    (!this.options.attribution &&
                      t.attributionControl &&
                      n.copyrightText &&
                      ((this.options.attribution = n.copyrightText), t.attributionControl.addAttribution(this.getAttribution())),
                    ...
                    this._lodMap = {};
                    for (var s = n.tileInfo.lods, r = ut.MercatorZoomLevels, a = 0; a < s.length; a++) {
                      var h = s[a];
                      for (var l in r) {
                        var u = r[l];
        ...
        authenticate: function (t) {
          var e = '?token=' + t;
          return (
            (this.tileUrl = this.options.token ? this.tileUrl.replace(/\?token=(.+)/g, e) : this.tileUrl + e),
      ...
      dt = e.Layer.extend({
        ...
        onAdd: function (t) {
          F(t),
            ...
            this._currentImage && this._currentImage._bounds.equals(this._map.getBounds())
              ...
              : this._currentImage && (this._map.removeLayer(this._currentImage), (this._currentImage = null)),
            this._update(),
            ...
            this.metadata(function (e, i) {
              !e &&
                ...
                t.attributionControl &&
                i.copyrightText &&
                ((this.options.attribution = i.copyrightText), t.attributionControl.addAttribution(this.getAttribution()));
            }, this);
        },
        onRemove: function (t) {
          N(t),
        ...
        bringToFront: function () {
          return (
            ...
            this._currentImage && (this._currentImage.bringToFront(), this._setAutoZIndex(Math.max)),
            this
          );
        },
        bringToBack: function () {
          return (
            (this.options.position = 'back'), this._currentImage && (this._currentImage.bringToBack(), this._setAutoZIndex(Math.min)), this
          );
        },
        setZIndex: function (t) {
        ...
        _setAutoZIndex: function (t) {
          if (this._currentImage) {
            for (var e, i = this._currentImage.getPane().children, n = -t(-1 / 0, 1 / 0), o = 0, s = i.length; o < s; o++)
              (e = i[o].style.zIndex), i[o] !== this._currentImage._image && e && (n = t(n, +e));
        ...
        _renderImage: function (t, e, i) {
          if (this._map) {
            ...
            var n = new ct(t, e, {
              ...
              o = function () {
                this._map.removeLayer(n), this.fire('error'), n.off('load', s, this);
              },
              s = function (t) {
                if ((n.off('error', o, this), this._map)) {
                  ...
                  i._bounds.equals(e) && i._bounds.equals(this._map.getBounds())
                    ? ((this._currentImage = i),
                      'front' === this.options.position ? this.bringToFront() : 'back' === this.options.position && this.bringToBack(),
            ...
            if (!(this._animatingZoom || (this._map._panTransition && this._map._panTransition._inProgress)))
              if (t > this.options.maxZoom || t < this.options.minZoom)
                ...
                e.Util.extend(n, this.options.requestParams),
                  n
                    ? (this._requestExport(n, i), this.fire('loading', { bounds: i }))
                    : this._currentImage && (this._currentImage._map.removeLayer(this._currentImage), (this._currentImage = null));
              }
          }
        },
      ...
      pt = dt.extend({
        ...
        initialize: function (t) {
          (t = Z(t)), (this.service = st(t)), this.service.addEventParent(this), e.Util.setOptions(this, t);
        },
        ...
        setNoData: function (t, i) {
          return (
            e.Util.isArray(t) ? (this.options.noData = t.join(',')) : (this.options.noData = t.toString()),
        ...
        _requestExport: function (t, i) {
          if ('json' === this.options.f)
            ...
            this.options.proxy && (n = this.options.proxy + '?' + n), this._renderImage(n, i);
          }
        },
      }),
      _t = dt.extend({
        options: { updateInterval: 150, layers: !1, layerDefs: !1, timeOptions: !1, format: 'png32', transparent: !0, f: 'json' },
        initialize: function (t) {
          (t = Z(t)), (this.service = nt(t)), this.service.addEventParent(this), e.Util.setOptions(this, t);
        },
        ...
        _getPopupData: function (t) {
          ...
          if (
            ((i = this.options.popup ? this.options.popup.on(this._map).at(t.latlng) : this.identify().on(this._map).at(t.latlng)).params
              .maxAllowableOffset || i.simplify(this._map, 0.5),
            (this.options.popup && this.options.popup.params && this.options.popup.params.layers) ||
              (this.options.layers ? i.layers('visible:' + this.options.layers.join(',')) : i.layers('visible')),
            this.options.layerDefs && 'string' != typeof this.options.layerDefs && !i.params.layerDefs)
          )
            for (var o in this.options.layerDefs)
              Object.prototype.hasOwnProperty.call(this.options.layerDefs, o) && i.layerDef(o, this.options.layerDefs[o]);
          i.run(n), (this._shouldRenderPopup = !0), (this._lastClick = t.latlng);
        },
        _buildExportParams: function () {
          var t = parseInt(this._map.options.crs.code.split(':')[1], 10),
            e = {
          ...
          return (
            this.options.layerDefs &&
              (e.layerDefs = 'string' == typeof this.options.layerDefs ? this.options.layerDefs : JSON.stringify(this.options.layerDefs)),
            ...
            this.service.request(
              ...
              function (t, e) {
                t ||
                  ...
                  this.options.proxy && e.href && (e.href = this.options.proxy + '?' + e.href),
      ...
      mt = e.Layer.extend({
        options: { cellSize: 512, updateWhenIdle: e.Browser.mobile, updateInterval: 150, noWrap: !1, keepBuffer: 1.5 },
        initialize: function (t) {
          e.Util.setOptions(this, t);
        },
        onAdd: function (t) {
        ...
        getEvents: function () {
          ...
          return (
            this.options.updateWhenIdle ||
              (this._onMove || (this._onMove = e.Util.throttle(this._onMoveEnd, this.options.updateInterval, this)),
              (t.move = this._onMove)),
            t
          );
        },
        ...
        _retainParent: function (t, i, n, o) {
          ...
          var l = this._cellCoordsToKey(h),
            u = this._cells[l];
          return u && u.active ? ((u.retain = !0), !0) : (u && u.loaded && (u.retain = !0), a > o && this._retainParent(s, r, a, o));
        },
        ...
        _reuseCell: function (t) {
          ...
          this.cellEnter(n, i, e), this.fire('cellenter', { key: e, coords: i, bounds: n });
        },
    ...
    (ft.prototype.query = function (t) {
      ...
      (ft.prototype.getIndex = function (t) {
        ...
        for (var e, i, n = 0, o = this.values.length - 1; n <= o; )
          if (((e = ((n + o) / 2) | 0), +(i = this.values[Math.round(e)]).value < +t)) n = e + 1;
          else {
    ...
    var gt = mt.extend({
        ...
        initialize: function (t) {
          if (
            ...
            for (var i = !1, n = 0; n < this.options.fields.length; n++)
              this.options.fields[n].match(/^(OBJECTID|FID|OID|ID)$/i) && (i = !0);
            !1 === i &&
              _(
            ...
            this.service.metadata(function (e, i) {
              if (!e) {
                var n = i.supportedQueryFormats,
                  o = !1;
                (!1 === this.service.options.isModern || this.options.fetchAllFeatures) && (o = !0),
                  !o && n && -1 !== n.indexOf('geoJSON') && (this.service.options.isModern = !0),
        ...
        onRemove: function (t) {
          return N(t), t.off('zoomend', this._handleZoomChange, this), mt.prototype.onRemove.call(this, t);
        },
        getAttribution: function () {
          return this.options.attribution;
        },
            ...
            this._buildQuery(t, o).run(function (r, a, h) {
              h && h.exceededTransferLimit && this.fire('drawlimitexceeded'),
                this.options.where === s &&
                  ...
                  n && n.call(this, r, a),
                  h &&
                    (h.exceededTransferLimit || (h.properties && h.properties.exceededTransferLimit)) &&
        ...
        _addFeatures: function (t, e) {
          ...
          for (var n = t.length - 1; n >= 0; n--) {
            var o = t[n].id;
            -1 === this._currentSnapshot.indexOf(o) && this._currentSnapshot.push(o),
              void 0 !== i && -1 === this._cache[i].indexOf(o) && this._cache[i].push(o);
          }
        ...
        _buildQuery: function (t, i) {
          ...
          return (
            this.options.fetchAllFeatures && !isNaN(parseInt(i)) && (n = n.offset(i)),
          ...
          for (
            var o = [],
              ...
              h = e.Util.bind(function (h, l) {
                if ((h && (a = h), l)) for (var u = l.features.length - 1; u >= 0; u--) s.push(l.features[u].id);
                --r <= 0 &&
                  this._visibleZoom() &&
        ...
        _getFeaturesInTimeRange: function (t, e) {
          ...
          if (this.options.timeField.start && this.options.timeField.end) {
            ...
            if (!this._timeIndex)
              return _('You must set timeField in the layer constructor in order to manipulate the start and end time filter.'), [];
        ...
        _buildTimeIndexes: function (t) {
          ...
          if (this.options.timeField.start && this.options.timeField.end) {
            ...
            for (e = t.length - 1; e >= 0; e--)
              (i = t[e]),
                n.push({ id: i.id, value: new Date(i.properties[this.options.timeField.start]) }),
                o.push({ id: i.id, value: new Date(i.properties[this.options.timeField.end]) });
            this._startTimeIndex.bulkAdd(n), this._endTimeIndex.bulkAdd(o);
          } else {
            var s = [];
            for (e = t.length - 1; e >= 0; e--) (i = t[e]), s.push({ id: i.id, value: new Date(i.properties[this.options.timeField]) });
        ...
        _featureWithinTimeRange: function (t) {
          ...
          if (this.options.timeField.start && this.options.timeField.end) {
            ...
            return (o >= e && o <= i) || (s >= e && s <= i) || (o <= e && s >= i);
          }
        },
                  ...
                  e.Util.bind(function (t, e) {
                    if (!t) {
                      for (var o = r.length - 1; o >= 0; o--)
                        (r[o].properties[s.objectIdField] = r.length > 1 ? e[o].objectId : e.objectId),
        ...
        updateFeatures: function (t, e, i) {
          ...
          this.service.updateFeatures(
            ...
            function (t, o) {
              if (!t) {
                for (var s = n.length - 1; s >= 0; s--) this.removeLayers([n[s].id], !0);
                this._addFeatures(n);
              }
              e && e.call(i, t, o);
            },
        ...
        deleteFeatures: function (t, e, i) {
          return this.service.deleteFeatures(
            ...
            function (t, n) {
              var o = n.length ? n : [n];
              if (!t && o.length > 0) for (var s = o.length - 1; s >= 0; s--) this.removeLayers([o[s].objectId], !0);
              e && e.call(i, t, n);
            },
            this
          );
      ...
      vt = gt.extend({
        ...
        onRemove: function (t) {
          for (var e in this._layers)
            t.removeLayer(this._layers[e]), this.fire('removefeature', { feature: this._layers[e].feature, permanent: !1 }, !0);
        ...
        createLayers: function (t) {
          for (var e = t.length - 1; e >= 0; e--) {
            ...
            !this._visibleZoom() ||
              ...
              (this._map.addLayer(o), this.fire('addfeature', { feature: o.feature }, !0)),
              ...
              o ||
                ((i = this.createNewLayer(n))
                  ? ((i.feature = n),
                    ...
                    this._visibleZoom() &&
                      (!this.options.timeField || (this.options.timeField && this._featureWithinTimeRange(n))) &&
        ...
        removeLayers: function (t, e) {
          for (var i = t.length - 1; i >= 0; i--) {
            var n = t[i],
              o = this._layers[n];
            o && (this.fire('removefeature', { feature: o.feature, permanent: e }, !0), this._map.removeLayer(o)),
                ...
                if (this._map) {
                  ...
                  if (!this._activeCells[e] && n) {
                    ...
                    s && this.removeLayers(n, !this.options.cacheLayers),
                      !this.options.cacheLayers && s && (delete this._cache[t], delete this._cells[e], delete this._activeCells[e]);
                  }
                }
              }, this)
            );
        ...
        eachActiveFeature: function (t, e) {
          if (this._map) {
            ...
            for (var n in this._layers)
              -1 !== this._currentSnapshot.indexOf(this._layers[n].feature.id) &&
                (('function' == typeof this._layers[n].getLatLng && i.contains(this._layers[n].getLatLng())) ||
                  ('function' == typeof this._layers[n].getBounds && i.intersects(this._layers[n].getBounds()))) &&
        ...
        _redraw: function (t) {
          ...
          if (i && i.setIcon && this.options.pointToLayer && this.options.pointToLayer) {
            var o = this.options.pointToLayer(n, e.latLng(n.geometry.coordinates[1], n.geometry.coordinates[0])).options.icon;
            i.setIcon(o);
          }
          if (i && i.setStyle && this.options.pointToLayer) {
            var s = this.options.pointToLayer(n, e.latLng(n.geometry.coordinates[1], n.geometry.coordinates[0])).options;
  ...
  (function (t, e) {
    'object' == typeof exports && 'undefined' != typeof module
      ...
      : e(
          (((t = 'undefined' != typeof globalThis ? globalThis : t || self).L = t.L || {}),
          (t.L.esri = t.L.esri || {}),
          (t.L.esri.Geocoding = {})),
          t.L,
          t.L.esri
    ...
    'use strict';
    var n = 'https://geocode-api.arcgis.com/arcgis/rest/services/World/GeocodeServer/',
      o = i.Task.extend({
        ...
        _processGeocoderResponse: function (t) {
          for (var n = [], o = 0; o < t.candidates.length; o++) {
            ...
            n.push({ text: s.address, bounds: r, score: s.score, latlng: e.latLng(s.location.y, s.location.x), properties: s.attributes });
          }
          return n;
        },
      });
    ...
    var r = i.Task.extend({
      ...
      setters: { distance: 'distance', language: 'langCode', intersection: 'returnIntersection', apikey: 'apikey' },
      initialize: function (t) {
        ((t = t || {}).url = t.url || n), i.Task.prototype.initialize.call(this, t);
      },
      latlng: function (t) {
      ...
      run: function (t, i) {
        return (
          ...
          this.request(function (n, o) {
            var s;
            (s = n ? void 0 : { latlng: e.latLng(o.location.y, o.location.x), address: o.address }), t.call(i, n, s, o);
          }, this)
        );
      },
    });
    ...
    var h = i.Task.extend({
      ...
      within: function (t) {
        ...
        return (
          ...
          (this.params.distance = Math.min(Math.max(n.distanceTo(o), 2e3), 5e4)),
    ...
    var u = i.Service.extend({
        initialize: function (t) {
          (t = t || {}).apikey && (t.token = t.apikey),
            t.url
              ? (i.Service.prototype.initialize.call(this, t), this._confirmSuggestSupport())
              : ((t.url = n), (t.supportsSuggest = !0), i.Service.prototype.initialize.call(this, t));
        },
        geocode: function () {
          return s(this);
        },
      ...
      c = e.Evented.extend({
        ...
        initialize: function (t, i) {
          if ((e.Util.setOptions(this, i), (this._control = t), !i || !i.providers || !i.providers.length))
              ...
              s--,
                e ||
                  ...
                  s <= 0 &&
                    ...
                    this.fire('results', { results: r, bounds: o, latlng: o ? o.getCenter() : void 0, text: t }, !0),
                    this.options.zoomToResult && o && this._control._map.fitBounds(o),
                    this.fire('load')));
            }, this);
          if (i) s++, n.results(t, i, this._searchBounds(), a);
          else for (var h = 0; h < this._providers.length; h++) s++, this._providers[h].results(t, i, this._searchBounds(), a);
        },
        _suggest: function (t) {
          var i = this._providers.length,
            ...
            o = e.Util.bind(function (t, o) {
              return e.Util.bind(function (e, s) {
                if (((i -= 1), (n += s.length), e))
                  return this._control._clearProviderSuggestions(o), void this._control._finalizeSuggestions(i, n);
                if (s.length) for (var r = 0; r < s.length; r++) s[r].provider = o;
                else this._control._renderSuggestions(s);
                o._lastRender !== t && this._control._clearProviderSuggestions(o),
                  s.length && this._control._input.value === t && ((o._lastRender = t), this._control._renderSuggestions(s)),
        ...
        _searchBounds: function () {
          return null !== this.options.searchBounds
            ...
            ? null
            : !0 === this.options.useMapBounds || this.options.useMapBounds <= this._control._map.getZoom()
            ? this._control._map.getBounds()
            : null;
        },
        _boundsFromResults: function (t) {
          if (t.length) {
            for (var i = e.latLngBounds([0, 0], [0, 0]), n = [], o = [], s = t.length - 1; s >= 0; s--) {
              var r = t[s];
          ...
          n.run(function (t, e, n) {
            ...
            if (!t)
              for (; n.suggestions.length && o.length <= this.options.maxResults - 1; ) {
                ...
                s.isCollection || o.push({ text: s.text, unformattedText: s.text, magicKey: s.magicKey });
              }
            i(t, o);
          }, this)
        );
    ...
    var m = e.Control.extend({
        ...
        initialize: function (t) {
          e.Util.setOptions(this, t),
            (t && t.providers && t.providers.length) || (t || (t = {}), (t.providers = [_()])),
          ...
          for (var s = [], r = 0; r < t.length; r++) {
            ...
            if (
              (!o &&
                ...
                (((o = e.DomUtil.create('div', 'geocoder-control-header', a.provider._contentsElement)).textContent =
                  a.provider.options.label),
                (o.innerText = a.provider.options.label),
                (i = a.provider.options.label)),
              n || (n = e.DomUtil.create('ul', 'geocoder-control-list', a.provider._contentsElement)),
              -1 === s.indexOf(a.text))
            ) {
              ...
              for (var l = 0; l < n.childNodes.length; l++)
                n.childNodes[l].innerHTML === a.text && (n.childNodes[l]['data-magic-key'] += ',' + a.magicKey);
            s.push(a.text);
          }
        ...
        _setSuggestionsBottomPosition: function () {
          (this._suggestions.style.maxHeight =
            this._map.getSize().y - this._map._controlCorners[this.getPosition()].offsetHeight - this._wrapper.offsetHeight + 'px'),
        ...
        clear: function () {
          this._clearAllSuggestions(),
            this.options.collapseAfterResult &&
              ...
              e.DomUtil.removeClass(this._wrapper, 'geocoder-control-expanded')),
        ...
        disable: function () {
          (this._input.disabled = !0),
            ...
            e.DomEvent.removeListener(this._wrapper, 'click', this._setupClick, this);
        },
        enable: function () {
          (this._input.disabled = !1),
            e.DomUtil.removeClass(this._input, 'geocoder-control-input-disabled'),
            e.DomEvent.addListener(this._wrapper, 'click', this._setupClick, this);
        },
        getAttribution: function () {
          for (var t = [], e = 0; e < this._providers.length; e++)
            this._providers[e].options.attribution && t.push(this._providers[e].options.attribution);
          return t.join(', ');
        },
        geocodeSuggestion: function (t) {
          ...
          e.classList.contains('geocoder-control-suggestions') ||
            ...
            this._geosearchCore._geocode(e.unformattedText, e['data-magic-key'], e.provider),
            this.clear());
        },
        onAdd: function (t) {
          i.Util.setEsriAttribution(t),
            ...
            (this._input = e.DomUtil.create('input', 'geocoder-control-input leaflet-bar', this._wrapper)),
            (this._input.title = this.options.title),
            this.options.expanded &&
              (e.DomUtil.addClass(this._wrapper, 'geocoder-control-expanded'), (this._input.placeholder = this.options.placeholder)),
            (this._suggestions = e.DomUtil.create('div', 'geocoder-control-suggestions leaflet-bar', this._wrapper));
          for (var n = 0; n < this.options.providers.length; n++)
            this.options.providers[n]._contentsElement = e.DomUtil.create('div', null, this._suggestions);
          ...
          return (
            ...
            e.DomEvent.addListener(this._wrapper, 'click', this._setupClick, this),
            e.DomEvent.addListener(this._suggestions, 'mousedown', this.geocodeSuggestion, this),
            e.DomEvent.addListener(
              this._input,
              'blur',
              function (t) {
              ...
              function (t) {
                ...
                for (
                  var n,
                    ...
                    s = this._suggestions.querySelectorAll('.geocoder-control-selected')[0],
                    r = 0;
                  r < o.length;
                  r++
                )
                ...
                switch (t.keyCode) {
                  case 13:
                    s
                      ? ((this._input.value = s.innerText),
                        this._geosearchCore._geocode(s.unformattedText, s['data-magic-key'], s.provider),
                        this.clear())
                      ...
                      ? (e.DomUtil.addClass(o[0], 'geocoder-control-selected'),
                        this._geosearchCore._geocode(o[0].innerHTML, o[0]['data-magic-key'], o[0].provider))
                  ...
                  case 38:
                    ...
                    s && a
                      ...
                      : e.DomUtil.addClass(o[o.length - 1], 'geocoder-control-selected'),
                      e.DomEvent.preventDefault(t);
                    break;
                  case 40:
                    s && e.DomUtil.removeClass(s, 'geocoder-control-selected');
                    var h = o[n + 1];
                    s && h ? e.DomUtil.addClass(h, 'geocoder-control-selected') : e.DomUtil.addClass(o[0], 'geocoder-control-selected'),
                      e.DomEvent.preventDefault(t);
                    break;
                  default:
                ...
                function (t) {
                  ...
                  if (n.length < 2)
                    return (
                      ...
                      this._clearAllSuggestions(),
                      void e.DomUtil.removeClass(this._input, 'geocoder-control-loading')
                    );
                  27 !== i
                    ? 13 !== i &&
                      38 !== i &&
                      ...
                      ((this._lastValue = this._input.value),
                      e.DomUtil.addClass(this._input, 'geocoder-control-loading'),
            ...
            e.DomEvent.addListener(this._suggestions, 'mouseover', function (e) {
      ...
      f = i.FeatureLayerService.extend({
        ...
        suggestions: function (t, e, i) {
          ...
          return (
            e && n.intersects(e),
            this.options.idField && n.fields([this.options.idField].concat(this.options.searchFields)),
            n.run(function (t, e, n) {
              if (t) i(t, []);
              else {
        ...
        results: function (t, i, n, o) {
          ...
          return (
            i ? (delete s.params.where, s.featureIds([i])) : s.where(this._buildQuery(t)),
            n && s.within(n),
            s.run(
              e.Util.bind(function (t, e) {
      ...
      g = i.MapService.extend({
        ...
        initialize: function (t) {
          t.apikey && (t.token = t.apikey), i.MapService.prototype.initialize.call(this, t), this._getIdFields();
        },
        suggestions: function (t, e, i) {
          return this.find()
            .text(t)
        ...
        results: function (t, e, i, n) {
          ...
          } else o = this.find().text(t).fields(this.options.searchFields).layers(this.options.layers);
            ...
            if (!t) {
              ...
              for (var o = 0; o < e.features.length; o++) {
                ...
                if (((a = a || i.results[o].layerId), r && void 0 !== a)) {
                  ...
                  (r.layerId = a), (r.layerName = this._layerNames[a]), (r.displayFieldName = this._displayFields[a]);
                  var l = {
                    latlng: h.getCenter(),
                    bounds: h,
                    text: this.options.formatSuggestion.call(this, r),
