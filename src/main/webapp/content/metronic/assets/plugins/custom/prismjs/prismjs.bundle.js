  ...
  Prism = (function (e) {
    var t = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i,
      ...
      s = {
        ...
        highlight: function (e, t, a) {
          ...
          return (
            (n.tokens = s.tokenize(n.code, n.grammar)), s.hooks.run('after-tokenize', n), r.stringify(s.util.encode(n.tokens), n.language)
          );
        },
    ...
    if (
      ...
      (r.stringify = function e(t, a) {
        ...
        var r = { type: t.type, content: e(t.content, a), tag: 'span', classes: ['token', t.type], attributes: {}, language: a },
          i = t.alias;
  ...
  (function () {
    if (void 0 !== Prism && 'undefined' != typeof document) {
      ...
      Prism.fileHighlight = function () {
        r || (console.warn('Prism.fileHighlight is deprecated. Use `Prism.plugins.fileHighlight.highlight` instead.'), (r = !0)),
  ...
  (function () {
    if (void 0 !== Prism) {
      ...
      (a.prototype = {
        ...
        (Prism.plugins.NormalizeWhitespace = new a({ 'remove-trailing': !0, 'remove-indent': !0, 'left-trim': !0, 'right-trim': !0 })),
            ...
            if ((e.element && e.element.parentNode) || !e.code) {
              ...
              if (e.code && n && 'pre' === n.nodeName.toLowerCase()) {
                ...
                for (var o = n.childNodes, l = '', u = '', c = !1, d = 0; d < o.length; ++d) {
                  ...
                  p == e.element
                    ? (c = !0)
                    : '#text' === p.nodeName && (c ? (u += p.nodeValue) : (l += p.nodeValue), n.removeChild(p), --d);
                }
                if (e.element.children.length && Prism.plugins.KeepMarkup) {
                  var g = l + e.element.innerHTML + u;
                  (e.element.innerHTML = a.normalize(g, e.settings)), (e.code = e.element.textContent);
