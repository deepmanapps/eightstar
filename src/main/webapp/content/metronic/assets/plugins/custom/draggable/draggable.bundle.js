!(function (e, t) {
  ...
  return (function (e) {
    ...
    function (e, t, r) {
      ...
      class c extends i.default {
        ...
        [l]({ dragEvent: e }) {
          ...
          this.lastElements = Array.from(r).map(e => ({ domEl: e, offsetTop: e.offsetTop, offsetLeft: e.offsetLeft }));
        }
        [a]({ oldIndex: e, newIndex: t }) {
          ...
          cancelAnimationFrame(this.lastAnimationFrame),
            (this.lastAnimationFrame = requestAnimationFrame(() => {
              r.forEach(e =>
                (function ({ from: e, to: t }, { duration: r, easingFunction: n }) {
                  const o = e.domEl,
    ...
    function (e, t, r) {
      ...
      class g extends s.default {
        ...
        [u](e) {
          ...
          this.draggable.trigger(r),
            r.canceled() ||
              ...
              t.classList.remove(...this.draggable.getClassNamesFor('source:dragging')),
              t.classList.add(...this.draggable.getClassNamesFor('source:placed')),
              setTimeout(() => {
        ...
        [c](e) {
          ...
          this.draggable.trigger(r),
            r.canceled() ||
              (this.mirror && (this.mirror.style.display = ''), t.classList.add(...this.draggable.getClassNamesFor('source:dragging')));
        }
        [d]({ mirror: e }) {
          this.mirror = e;
        }
    ...
    function (e, t, r) {
      ...
      class d extends s.default {
        ...
        [l](e) {
          ...
          o ? (this.lastCollidingElement && this.draggable.trigger(n), this.draggable.trigger(r)) : s && this.draggable.trigger(n),
    ...
    function (e, t, r) {
      ...
      const h = {
        'sortable:sorted': function ({ dragEvent: e }) {
          ...
          if (e.over) {
            ...
            return e.source.compareDocumentPosition(e.over) & Node.DOCUMENT_POSITION_FOLLOWING
              ? `Placed ${t} after ${r}`
              : `Placed ${t} before ${r}`;
          }
      ...
      class g extends i.default {
        constructor(e = [], t = {}) {
          super(e, o({}, t, { announcements: o({}, h, t.announcements || {}) })),
            ...
            (this[c] = this[c].bind(this)),
            (this[d] = this[d].bind(this)),
            this.on('drag:start', this[l]).on('drag:over:container', this[u]).on('drag:over', this[c]).on('drag:stop', this[d]);
        }
        destroy() {
          super.destroy(),
            this.off('drag:start', this[l]).off('drag:over:container', this[u]).off('drag:over', this[c]).off('drag:stop', this[d]);
        }
        index(e) {
        ...
        getSortableElementsForContainer(e) {
          return [...e.querySelectorAll(this.options.draggable)].filter(
            t => t !== this.originalSource && t !== this.mirror && t.parentNode === e
          );
        }
        [l](e) {
        ...
        [u](e) {
          ...
          const { oldContainer: l, newContainer: u } = i,
            ...
            d = new a.SortableSortedEvent({ dragEvent: e, oldIndex: o, newIndex: c, oldContainer: l, newContainer: u });
          this.trigger(d);
        }
        [c](e) {
    ...
    function (e, t, r) {
      ...
      const d = {
        'swappabled:swapped': function ({ dragEvent: e, swappedElement: t }) {
          return `Swapped ${e.source.textContent.trim() || e.source.id || 'swappable element'} with ${
      ...
      class h extends i.default {
        constructor(e = [], t = {}) {
          super(e, o({}, t, { announcements: o({}, d, t.announcements || {}) })),
            (this.lastOver = null),
            (this[l] = this[l].bind(this)),
            (this[u] = this[u].bind(this)),
            (this[c] = this[c].bind(this)),
        ...
        [u](e) {
          ...
          this.lastOver && this.lastOver !== e.over && g(this.lastOver, e.source),
            this.lastOver === e.over ? (this.lastOver = null) : (this.lastOver = e.over),
            g(e.source, e.over);
    ...
    function (e, t, r) {
      ...
      const v = {
          'droppable:dropped': function ({ dragEvent: e, dropzone: t }) {
            return `Dropped ${e.source.textContent.trim() || e.source.id || 'draggable element'} into ${
              t.textContent.trim() || t.id || 'droppable element'
            }`;
          },
          'droppable:returned': function ({ dragEvent: e, dropzone: t }) {
            return `Returned ${e.source.textContent.trim() || e.source.id || 'draggable element'} from ${
              t.textContent.trim() || t.id || 'droppable element'
            }`;
          },
        },
      ...
      class y extends a.default {
        constructor(e = [], t = {}) {
          super(e, o({}, b, t, { classes: o({}, m, t.classes || {}), announcements: o({}, v, t.announcements || {}) })),
            (this.dropzones = null),
            ...
            (this[c] = this[c].bind(this)),
            (this[d] = this[d].bind(this)),
            this.on('drag:start', this[u]).on('drag:move', this[c]).on('drag:stop', this[d]);
        }
        destroy() {
        ...
        [c](e) {
          ...
          t && !t.classList.contains(this.getClassNameFor('droppable:occupied')) && this[h](e, t)
            ? (this.lastDropzone = t)
            : (t && t !== this.initialDropzone) || !this.lastDropzone || (this[g](e), (this.lastDropzone = null));
        }
        [d](e) {
    ...
    function (e, t, r) {
      ...
      class y {
        constructor(e = [document.body], t = {}) {
          ...
          (this.options = o({}, b, t, {
            ...
            exclude: { plugins: (t.exclude && t.exclude.plugins) || [], sensors: (t.exclude && t.exclude.sensors) || [] },
          })),
        ...
        removePlugin(...e) {
          return (
            this.plugins.filter(t => e.includes(t.constructor)).forEach(e => e.detach()),
            (this.plugins = this.plugins.filter(t => !e.includes(t.constructor))),
            this
          );
        }
        addSensor(...e) {
        ...
        removeSensor(...e) {
          return (
            this.sensors.filter(t => e.includes(t.constructor)).forEach(e => e.detach()),
            (this.sensors = this.sensors.filter(t => !e.includes(t.constructor))),
            this
          );
        }
        addContainer(...e) {
        ...
        [h](e) {
          ...
          const i = new d.DragStartEvent({ source: this.source, originalSource: this.originalSource, sourceContainer: n, sensorEvent: t });
        ...
        [p](e) {
          if (!this.dragging) return;
          const t = E(e),
            r = this.source || (0, s.closest)(t.originalEvent.target, this.options.draggable),
      ...
      (t.default = y),
        (y.Plugins = { Announcement: i.Announcement, Focusable: i.Focusable, Mirror: i.Mirror, Scrollable: i.Scrollable }),
      ...
      class f extends s.default {
        ...
        [l](e) {
          ...
          const t = document.elementFromPoint(e.clientX, e.clientY),
            r = e.currentTarget,
            n = new i.DragStartSensorEvent({ clientX: e.clientX, clientY: e.clientY, target: t, container: r, originalEvent: e });
      ...
      class f extends i.default {
        ...
        [d]() {
          const e = this.startEvent,
            ...
            r = (0, o.touchCoords)(e),
            n = new a.DragStartSensorEvent({ clientX: r.pageX, clientY: r.pageY, target: e.target, container: t, originalEvent: e });
        ...
        [h](e) {
          ...
          Object.assign(this, i),
            ...
            a < n.touch
              ...
              : l >= t && (document.removeEventListener('touchmove', this[h]), this[d]());
        }
        [c](e) {
          if (!this.dragging) return;
          const { pageX: t, pageY: r } = (0, o.touchCoords)(e),
            n = document.elementFromPoint(t - window.scrollX, r - window.scrollY),
            s = new a.DragMoveSensorEvent({ clientX: t, clientY: r, target: n, container: this.currentContainer, originalEvent: e });
        ...
        [u](e) {
          if (
            ...
            document.removeEventListener('touchmove', this[h]),
            this.currentContainer && this.currentContainer.removeEventListener('contextmenu', p),
            !this.dragging)
          )
            return;
          ...
          const { pageX: t, pageY: r } = (0, o.touchCoords)(e),
            n = document.elementFromPoint(t - window.scrollX, r - window.scrollY);
          e.preventDefault();
          const s = new a.DragStopSensorEvent({ clientX: t, clientY: r, target: n, container: this.currentContainer, originalEvent: e });
    ...
    function (e, t, r) {
      ...
      class f extends i.default {
        ...
        [h]() {
          const e = this.startEvent,
            t = this.currentContainer,
            r = new a.DragStartSensorEvent({ clientX: e.clientX, clientY: e.clientY, target: e.target, container: t, originalEvent: e });
          this.trigger(this.currentContainer, r),
            (this.dragging = !r.canceled()),
            this.dragging && (document.addEventListener('contextmenu', this[l], !0), document.addEventListener('mousemove', this[c]));
        }
        [g](e) {
          ...
          clearTimeout(this.mouseDownTimeout),
            a < i.mouse
              ...
              : l >= n && (document.removeEventListener('mousemove', this[g]), this[h]());
        }
        [c](e) {
          if (!this.dragging) return;
          const t = document.elementFromPoint(e.clientX, e.clientY),
        ...
        (t.default = function (e, t) {
          ...
          do {
            if (
              ...
              (h = d) ? (a ? n.call(h, r) : u ? [...s].includes(h) : c ? i === h : l && o(h)) : h)
            )
              return d;
            d = d.parentNode;
      ...
      class g extends i.default {
        ...
        [u](e) {
          ...
          'ontouchstart' in window &&
            ((r.y = window.pageYOffset || document.documentElement.scrollTop || document.body.scrollTop || 0),
        ...
        [d]() {
          ...
          if (i === document.body || i === document.documentElement || o) {
            ...
            r.top + n - l < t ? (i.scrollTop += e) : l - r.top < t && (i.scrollTop -= e),
              r.left + o - a < t ? (i.scrollLeft += e) : a - r.left < t && (i.scrollLeft -= e);
          }
          this.scrollAnimationFrame = requestAnimationFrame(this[d]);
        }
      }
    ...
    function (e, t, r) {
      ...
      class m extends i.default {
        ...
        [u](e) {
          if (e.canceled()) return;
          'ontouchstart' in window && document.addEventListener('scroll', this[f], !0),
            (this.initialScrollOffset = { x: window.scrollX, y: window.scrollY });
          const { source: t, originalSource: r, sourceContainer: n, sensorEvent: o } = e;
          this.lastMirrorMovedClient = { x: o.clientX, y: o.clientY };
          const s = new a.MirrorCreateEvent({ source: t, originalSource: r, sourceContainer: n, sensorEvent: o, dragEvent: e });
          if (
        ...
        [c](e) {
          ...
          if (this.options.thresholdX || this.options.thresholdY) {
            ...
            if (
              (Math.abs(e - o.clientX) < this.options.thresholdX ? (s = !1) : (this.lastMirrorMovedClient.x = o.clientX),
              Math.abs(t - o.clientY) < this.options.thresholdY ? (i = !1) : (this.lastMirrorMovedClient.y = o.clientY),
              !s && !i)
            )
              return;
          }
        ...
        [d](e) {
          if (
            ('ontouchstart' in window && document.removeEventListener('scroll', this[f], !0),
      ...
      function E(e) {
        ...
        return M(e => {
          ...
          (t.style.display = null),
            ...
            (t.style.left = 0),
            (t.style.margin = 0),
            n.constrainDimensions && ((t.style.height = i), (t.style.width = a)),
            ...
            e => {
              ...
              if (i) {
                ...
                (d.xAxis && d.yAxis) || t
                  ...
                  : d.yAxis && !d.xAxis && (n.style.transform = `translate3d(${u}px, ${o}px, 0)`),
  ...
  (function (e, t) {
    ...
    return (function (e) {
        ...
        (r(2).inspectSource = function (e) {
          ...
          (e.exports = function (e, t, r, a) {
            ...
            l && (s(r, 'name') || o(r, 'name', t)),
              e[t] !== r &&
                (l && (s(r, i) || o(r, i, e[t] ? '' + e[t] : u.join(String(t)))),
          ...
          l = function (e, t, r) {
            ...
            for (u in (f && (r = t), r))
              (d = ((c = !g && b && void 0 !== b[u]) ? b : r)[u]),
                (h = m && c ? a(d, n) : v && 'function' == typeof d ? a(Function.call, d) : d),
                b && i(b, u, d, e & l.U),
                y[u] != d && s(y, u, h),
                v && E[u] != d && (E[u] = d);
          };
      ...
      function (e, t, r) {
        ...
        })('versions', []).push({ version: n.version, mode: r(21) ? 'pure' : 'global', copyright: '© 2018 Denis Pushkarev (zloirock.ru)' });
      },
      function (e, t, r) {
        var n = r(8);
        e.exports = function (e, t) {
      ...
      function (e, t, r) {
        ...
        (h && g) ||
          ...
          'process' == r(20)(d)
            ...
            : f
            ? ((s = (o = new f()).port2), (o.port1.onmessage = E), (n = i(s.postMessage, s, 1)))
      ...
      function (e, t, r) {
        ...
        e.exports = function (e, t, r, v, m, b, y) {
          ...
          if (
            (L && (S = c(L.call(new e()))) !== Object.prototype && S.next && (u(S, M, !0), n || 'function' == typeof S[d] || i(S, d, p)),
            C &&
              D &&
              D.name !== f &&
              ((w = !0),
            ...
            if (((E = { values: C ? x : _(f), keys: b ? x : _(g), entries: j }), y)) for (O in E) O in P || s(P, O, E[O]);
      ...
      function (e, t, r) {
        ...
        e.exports =
          ...
          function (e, t) {
            var r;
            return (
              null !== e ? ((a.prototype = n(e)), (r = new a()), (a.prototype = null), (r[i] = e)) : (r = l()), void 0 === t ? r : o(r, t)
            );
          };
      },
      function (e, t, r) {
      ...
      function (e, t, r) {
        ...
        class y {
          ...
          removeContainer(...e) {
            return (
              (this.containers = this.containers.filter(t => !e.includes(t))), this.sensors.forEach(t => t.removeContainer(...e)), this
            );
          }
          on(e, ...t) {
            return this.emitter.on(e, ...t), this;
      ...
      function (e, t, r) {
        ...
        e.exports =
          ...
          r(23)(function () {
            ...
            ? function (e, t) {
                for (var r = i(e), l = arguments.length, u = 1, c = o.f, d = s.f; l > u; )
                  for (var h, g = a(arguments[u++]), f = c ? n(g).concat(c(g)) : n(g), p = f.length, v = 0; p > v; )
                  ...
                  var n = e._v,
                    ...
                    i = function (t) {
                      ...
                      try {
                        a
                          ? (o || (2 == e._h && N(e), (e._h = 1)),
                            !0 === a ? (r = n) : (c && c.enter(), (r = a(n)), c && (c.exit(), (i = !0))),
                            r === t.promise ? u(M('Promise-chain cycle')) : (s = X(r)) ? s.call(r, l, u) : l(r))
                          : u(n);
                      } catch (e) {
                        c && !i && c.exit(), u(e);
                      }
          ...
          return function (t, r) {
            ...
            return l < 0 || l >= u
              ? e
                ? ''
                : void 0
              : (s = a.charCodeAt(l)) < 55296 || s > 56319 || l + 1 === u || (i = a.charCodeAt(l + 1)) < 56320 || i > 57343
              ? e
                ? a.charAt(l)
                : s
              : e
        ...
        var n = r(1),
          ...
          W = function (e, t, r) {
            return (
              ...
              o(z, t)
                ? (r.enumerable
                    ? (o(e, F) && e[F][t] && (e[F][t] = !1), (r = _(r, { enumerable: S(0, !1) })))
          ...
          Z = function (e) {
            for (var t, r = e === I, n = j(r ? k : E(e)), s = [], i = 0; n.length > i; )
