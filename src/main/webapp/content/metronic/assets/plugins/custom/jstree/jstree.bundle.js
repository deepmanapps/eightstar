!(function (e) {
   ...
   */ if (!e.jstree) {
      ...
      (e.jstree.core.prototype = {
        ...
        _kbevent_to_func: function (e) {
          ...
          if (
            ...
            'shift-shift' === (t = t.sort().join('-').toLowerCase()) || 'ctrl-ctrl' === t || 'alt-alt' === t)
          )
            return null;
          var i,
            r,
          ...
          for (i in s)
            if (
              ...
              ('-' !== (r = i) &&
                '+' !== r &&
                (r = (r = r.replace('--', '-MINUS').replace('+-', '-MINUS').replace('++', '-PLUS').replace('-+', '-PLUS'))
                  .split(/-|\+/)
                  .sort()
                  .join('-')
                  .replace('MINUS', '-')
        ...
        load_node: function (t, i) {
          ...
          if (t.state.loaded) {
            ...
            o &&
              ...
              (t.children = []),
              (t.children_d = []),
              o && this.trigger('changed', { action: 'load_node', node: t, selected: this._data.core.selected });
          }
          return (
            (t.state.failed = !1),
            (t.state.loading = !0),
            ...
            this._load_node(
              ...
              function (e) {
                ...
                t.state.loaded &&
                  ...
                  o ? '#' !== t.id && s.addClass(t.state.opened ? 'jstree-open' : 'jstree-closed') : s.addClass('jstree-leaf')),
          ...
          return s
            ? e.vakata.is_function(s)
              ...
              ? s.url
                ...
                : ((r = e.vakata.is_array(s) ? e.extend(!0, [], s) : e.isPlainObject(s) ? e.extend(!0, {}, s) : s),
                  t.id === e.jstree.root
                    ? this._append_json_data(t, r, function (e) {
                        i.call(this, e);
                      })
        ...
        _append_html_data: function (t, i, r) {
            ...
            o.each(
              function (t, i) {
                (s = this._parse_model_from_html(e(i), d, _.parents.concat())) &&
                  (c.push(s), l.push(s), h[s].children_d.length && (l = l.concat(h[s].children_d)));
              }.bind(this)
            ),
              _.children = c,
              _.children_d = l,
          ...
          this.trigger('model', { nodes: l, parent: d }),
            ...
            this._data.core.selected.length !== g && this.trigger('changed', { action: 'model', selected: this._data.core.selected }),
            r.call(this, !0);
        },
                ...
                if (n.length && n[0].id !== t && n[0].parent !== t) {
                    ...
                    f[n[r].parent.toString()]
                      ...
                      : void 0 !== o &&
                        ((o._data.core.last_error = {
                          ...
                          data: JSON.stringify({ id: n[r].id.toString(), parent: n[r].parent.toString() }),
                        }),
                  ...
                  for (r = 0, s = n.length; r < s; r++)
                    (i = j(n[r], d, p.parents.concat())) &&
                      (c.push(i), l.push(i), f[i].children_d.length && (l = l.concat(f[i].children_d)));
              ...
              l = function (t, i) {
                if (null !== this.element) {
                  ...
                  t.add.length && (this._data.core.selected = this._data.core.selected.concat(t.add)),
                    ...
                    t.add.length && this.trigger('changed', { action: 'model', selected: this._data.core.selected }),
                    !i && c
                      ? c(function () {
                          r.call(o, !0);
                        })
              ...
              try {
                null === this._wrk &&
                  (this._wrk = window.URL.createObjectURL(
                    new window.Blob(['self.onmessage = ' + d.toString()], { type: 'text/javascript' })
                  )),
        ...
        _redraw: function () {
          ...
          this._model.force_full_redraw &&
            ...
            null !== n &&
              ...
              ((t = this.get_node(n, !0)) && t.length && t.children('.jstree-anchor')[0] !== d.activeElement
        ...
        draw_children: function (t) {
          ...
          if ((t.children('.jstree-children').remove(), (t = t[0]), i.children.length && i.state.loaded)) {
            for (
              (a = n.createElement('UL')).setAttribute('role', 'group'), a.className = 'jstree-children', r = 0, s = i.children.length;
              r < s;
              r++
            )
        ...
        redraw_node: function (t, i, r, s) {
          ...
          if (
            ...
            if (
              !(
                null === (n = a.parent !== e.jstree.root ? e('#' + a.parent.replace(e.jstree.idregex, '\\$&'), this.element)[0] : null) ||
          ...
          for (l in ((t = this._data.core.node.cloneNode(!0)), (g = 'jstree-node '), a.li_attr))
          ...
          if (null !== a.parent && f[a.parent] && !a.state.hidden && ((l = e.inArray(a.id, f[a.parent].children)), (b = a.id), -1 !== l))
            for (
              ...
              l < h && (f[f[a.parent].children[l]].state.hidden || (b = f[a.parent].children[l]), b === a.id);
              l++
            );
          ...
          a.state.loaded && !k
            ? (g += ' jstree-leaf')
            : ((g += a.state.opened && a.state.loaded ? ' jstree-open' : ' jstree-closed'),
              t.childNodes[1].setAttribute('aria-expanded', a.state.opened && a.state.loaded)),
          b === a.id && (g += ' jstree-last'),
          (t.id = a.id),
          (t.className = g),
          (g = (a.state.selected ? ' jstree-clicked' : '') + (a.state.disabled ? ' jstree-disabled' : '')),
          a.a_attr))
          ...
          if (
            ...
            this.settings.core.force_text ? t.childNodes[1].appendChild(u.createTextNode(a.text)) : (t.childNodes[1].innerHTML += a.text),
            i && a.children.length && (a.state.opened || s) && a.state.loaded)
          ) {
            for (
              (_ = u.createElement('UL')).setAttribute('role', 'group'), _.className = 'jstree-children', l = 0, h = a.children.length;
              l < h;
              l++
            )
          ...
          if ((c && t.appendChild(c), !r)) {
            ...
            m || ((m = u.createElement('UL')).setAttribute('role', 'group'), (m.className = 'jstree-children'), n.appendChild(m)),
        ...
        hide_node: function (t, i) {
          ...
          if (!(t = this.get_node(t)) || t.id === e.jstree.root) return !1;
          t.state.hidden ||
            ((t.state.hidden = !0), this._node_changed(t.parent), i || this.redraw(), this.trigger('hide_node', { node: t }));
        },
        show_node: function (t, i) {
          ...
          if (!(t = this.get_node(t)) || t.id === e.jstree.root) return !1;
          t.state.hidden &&
            ((t.state.hidden = !1), this._node_changed(t.parent), i || this.redraw(), this.trigger('show_node', { node: t }));
        },
        hide_all: function (t) {
          var i,
            r = this._model.data,
        ...
        activate_node: function (e, i) {
          ...
          if (
            ...
            this.settings.core.multiple &&
              ...
              (!i.shiftKey ||
                (this._data.core.last_clicked && this.get_parent(e) && this.get_parent(e) === this._data.core.last_clicked.parent)))
          )
            if (i.shiftKey) {
              var r,
                s,
        ...
        select_node: function (t, i, r, s) {
          ...
          (a = this.get_node(t, !0)),
            t.state.selected ||
              ...
              i || this.trigger('changed', { action: 'select_node', node: t, selected: this._data.core.selected, event: s }));
        },
        deselect_node: function (t, i, r) {
          ...
          (n = this.get_node(t, !0)),
            t.state.selected &&
              ...
              this.trigger('deselect_node', { node: t, selected: this._data.core.selected, event: r }),
              i || this.trigger('changed', { action: 'deselect_node', node: t, selected: this._data.core.selected, event: r }));
        },
        select_all: function (t) {
          ...
          for (
            this._data.core.selected = this._model.data[e.jstree.root].children_d.concat(), i = 0, r = this._data.core.selected.length;
            i < r;
            i++
          )
          ...
          this.redraw(!0),
            ...
            t || this.trigger('changed', { action: 'select_all', selected: this._data.core.selected, old_selection: s });
        },
        deselect_all: function (e) {
          ...
          (this._data.core.selected = []),
            ...
            e || this.trigger('changed', { action: 'deselect_all', selected: this._data.core.selected, old_selection: r });
        },
        ...
        set_state: function (i, r) {
          if (i) {
            if (
              ...
              if (i.core.loaded)
                return (
                  this.settings.core.loaded_state && e.vakata.is_array(i.core.loaded) && i.core.loaded.length
        ...
        refresh_node: function (t) {
          ...
          r.push(t.id),
            ...
            this._load_nodes(
              r,
              function (e) {
                this.open_node(i, !1, 0), this.select_node(s), this.trigger('refresh_node', { node: t, nodes: e });
              }.bind(this),
              !1,
              !0
            );
        ...
        set_id: function (t, i) {
          ...
          var r,
            ...
            a = this._model.data,
            n = t.id;
          for (i = i.toString(), a[t.parent].children[e.inArray(t.id, a[t.parent].children)] = i, r = 0, s = t.parents.length; r < s; r++)
          ...
          return (
            ...
            (r = this.get_node(t.id, !0)) &&
              (r.attr('id', i), this.element.attr('aria-activedescendant') === t.id && this.element.attr('aria-activedescendant', i)),
            delete a[t.id],
            (t.id = i),
            (t.li_attr.id = i),
            (a[i] = t),
        ...
        create_node: function (i, r, s, a, n) {
          ...
          switch (
            ...
            (r = 'string' == typeof r ? { text: r } : e.extend(!0, {}, r)).text === t && (r.text = this.get_string('New node')),
        ...
        delete_node: function (t) {
          ...
          for (
            h &&
              ...
              h && this.trigger('changed', { action: 'delete_node', node: t, selected: this._data.core.selected, parent: s.id }),
              c = 0,
              l = n.length;
            c < l;
            c++
            ...
            -1 !== e.inArray(this._data.core.focused, n) &&
              ...
              s.id === e.jstree.root
                ? this._model.data[e.jstree.root].children[0] &&
                  this.get_node(this._model.data[e.jstree.root].children[0], !0).children('.jstree-anchor').triger('focus')
            ...
            if (!((a && a.is_multi) || 'move_node' !== t || e.inArray(i.id, r.children) !== s))
              return (
                (this._data.core.last_error = {
                  ...
                  data: JSON.stringify({ chk: t, pos: s, obj: !(!i || !i.id) && i.id, par: !(!r || !r.id) && r.id }),
                }),
                !1
              );
            if (
          ...
          return (
            ...
            n && n.functions && (!1 === n.functions[t] || !0 === n.functions[t])
              ? (!1 === n.functions[t] &&
                ...
                n.functions[t])
              : !(!1 === o || (e.vakata.is_function(o) && !1 === o.call(this, t, i, r, s, a)) || (o && !1 === o[t])) ||
                ((this._data.core.last_error = {
                  error: 'check',
                  plugin: 'core',
                  id: 'core_03',
        ...
        move_node: function (i, r, s, a, n, o, d) {
          ...
          if (
            ...
            (g = s.toString().match(/^(before|after)$/) && r.id !== e.jstree.root ? this.get_node(r.parent) : r),
            ...
            return !!(m = this.copy_node(i, r, s, a, n, !1, d)) && (u && u.delete_node(i), m);
          ...
          if (i.parent === g.id) {
            for (
              p = g.children.concat(),
                -1 !== (m = e.inArray(i.id, p)) && ((p = e.vakata.array_remove(p, m)), s > m && s--),
                m = [],
                v = 0,
                j = p.length;
              v < j;
            ...
            for ((m = i.children_d.concat()).push(i.id), v = 0, j = i.parents.length; v < j; v++) {
              for (p = [], k = 0, b = (y = u._model.data[i.parents[v]].children_d).length; k < b; k++)
                -1 === e.inArray(y[k], m) && p.push(y[k]);
              u._model.data[i.parents[v]].children_d = p;
            }
            for (
              u._model.data[h].children = e.vakata.array_remove_item(u._model.data[h].children, i.id), v = 0, j = g.parents.length;
              v < j;
              v++
            )
              this._model.data[g.parents[v]].children_d = this._model.data[g.parents[v]].children_d.concat(m);
        ...
        copy_node: function (i, r, s, a, n, o, d) {
          ...
          switch (
            ...
            !(v = d || (this._model.data[i.id] ? this : e.jstree.reference(i.id))) || !v._id || this._id !== v._id,
          ...
          for (
            ...
            this._model.data[m.parents[g]].children_d = this._model.data[m.parents[g]].children_d.concat(h);
          ...
          return (
            ...
            this.trigger('copy_node', {
              ...
              old_parent: p,
              old_position:
                v && v._id && p && v._model.data[p] && v._model.data[p].children ? e.inArray(i.id, v._model.data[p].children) : -1,
              is_multi: v && v._id && v._id !== this._id,
              is_foreign: !v || !v._id,
              old_instance: v,
              new_instance: this,
        ...
        cut: function (t) {
          ...
          var i,
            ...
            o,
            d = [];
          for (n = 0, o = t.length; n < o; n++) (i = this.get_node(t[n])) && i.id && i.id !== e.jstree.root && d.push(i);
        ...
        copy: function (t) {
          ...
          for (n = 0, o = t.length; n < o; n++) (i = this.get_node(t[n])) && i.id && i.id !== e.jstree.root && d.push(i);
          if (!d.length) return !1;
          (r = d), (a = this), (s = 'copy_node'), this.trigger('copy', { node: t });
        },
        get_buffer: function () {
        ...
        paste: function (e, t) {
          ...
          this[s](r, e, t, !1, !1, !1, a) && this.trigger('paste', { parent: e.id, node: r, mode: s }), (r = !1), (s = !1), (a = !1);
        },
        ...
        edit: function (t, i, r) {
          ...
          return (
			...
			*/
                (c = i),
                (l = e('<div></div>', {
                  css: { position: 'absolute', top: '-200px', left: s ? '0px' : '-1000px', visibility: 'hidden' },
                }).appendTo(d.body)),
                (h = e('<input />', {
                  value: c,
                  ...
                  blur: function (i) {
                    ...
                    '' === a && (a = c),
                      ...
                      (t = this.get_node(t)),
                      this.set_text(t, c),
                      (s = !!this.rename_node(t, d ? e('<div></div>').text(a).text() : e('<div></div>').append(e.parseHTML(a)).html())) ||
                        this.set_text(t, c),
                      (this._data.core.focused = g.id),
                      setTimeout(
                        function () {
                          var e = this.get_node(g.id, !0);
                          e.length && ((this._data.core.focused = g.id), e.children('.jstree-anchor').trigger('focus'));
                        }.bind(this),
                        0
                      ),
    ...
    (g.className = 'jstree-icon jstree-checkbox'),
        ...
        (this.bind = function () {
              ...
              this.element.on(
                ...
                function (e, t) {
                  ...
                  for (i = 0, r = a.length; i < r; i++)
                    (s[a[i]].state.checked =
                      s[a[i]].state.checked || (s[a[i]].original && s[a[i]].original.state && s[a[i]].original.state.checked)),
                  ...
                  function (t, i) {
                    ...
                    if (-1 !== g.indexOf('down'))
                      if (l.state[u ? 'selected' : 'checked']) {
                        for (s = 0, a = h.length; s < a; s++) c[h[s]].state[u ? 'selected' : 'checked'] = !0;
                        this._data[u ? 'core' : 'checkbox'].selected = this._data[u ? 'core' : 'checkbox'].selected.concat(h);
                      } else
                        for (s = 0, a = h.length; s < a; s++)
                          if (c[h[s]].state[u ? 'selected' : 'checked']) {
                            for (n = 0, o = c[h[s]].children_d.length; n < o; n++)
                              c[c[h[s]].children_d[n]].state[u ? 'selected' : 'checked'] = !0;
                            this._data[u ? 'core' : 'checkbox'].selected = this._data[u ? 'core' : 'checkbox'].selected.concat(
                              c[h[s]].children_d
                            );
                          }
                    if (-1 !== g.indexOf('up')) {
                      ...
                      for (n = 0, o = (_ = e.vakata.array_unique(_)).length; n < o; n++)
                        for (l = c[_[n]]; l && l.id !== e.jstree.root; ) {
                          for (r = 0, s = 0, a = l.children.length; s < a; s++) r += c[l.children[s]].state[u ? 'selected' : 'checked'];
                          if (r !== a) break;
                          (l.state[u ? 'selected' : 'checked'] = !0),
                            this._data[u ? 'core' : 'checkbox'].selected.push(l.id),
                            (d = this.get_node(l, !0)) &&
                              d.length &&
                              d
                ...
                .on(
                  ...
                  function (t, i) {
                    ...
                    if (-1 !== l.indexOf('down')) {
                      ...
                      for (r = 0, s = f.length; r < s; r++) u.indexOf(f[r]) > -1 ? (_[f[r]] = !0) : delete _[f[r]];
                    }
                    if (-1 !== l.indexOf('up'))
          ...
          (this.get_undetermined = function (i) {
            ...
            for (
                    ...
                    if (c.state.loaded) {
                      for (r = 0, s = c.children_d.length; r < s; r++)
                        if (
                          ...
                          for (
                            o[i.id] === t && i.id !== e.jstree.root && ((o[i.id] = !0), h.push(i.id)), a = 0, n = i.parents.length;
                            a < n;
                            a++
                          )
                      ...
                      for (
                        o[c.id] === t && c.id !== e.jstree.root && ((o[c.id] = !0), h.push(c.id)), a = 0, n = c.parents.length;
                        a < n;
                        a++
                      )
              ...
              d[h[r]].state[c ? 'selected' : 'checked'] || g.push(i ? d[h[r]] : h[r]);
            return g;
          }),
          (this._undetermined = function () {
            if (null !== this.element) {
              ...
              for (this.element.find('.jstree-undetermined').removeClass('jstree-undetermined'), e = 0, t = r.length; e < t; e++)
          ...
          (this.redraw_node = function (e, t, i, s) {
            if ((e = r.redraw_node.apply(this, arguments))) {
              ...
              o &&
                (!this.settings.checkbox.tie_selection && this._model.data[e.id].state.checked && (o.className += ' jstree-checked'),
                (d = g.cloneNode(!1)),
          ...
          (this._cascade_new_checked_state = function (e, t) {
            ...
            if (
              ...
              (s = this.get_checked_descendants(e)), n.state[a ? 'selected' : 'checked'] && s.push(n.id), (o = o.concat(s));
            else {
              if (n.children)
          ...
          (this.check_node = function (t, i) {
            ...
            (r = this.get_node(t, !0)),
              t.state.checked ||
                ...
                this.trigger('check_node', { node: t, selected: this._data.checkbox.selected, event: i }));
          }),
          (this.uncheck_node = function (t, i) {
            ...
            (a = this.get_node(t, !0)),
              t.state.checked &&
                ...
                this.trigger('uncheck_node', { node: t, selected: this._data.checkbox.selected, event: i }));
          }),
      ...
      (function (e) {
        var t = !1,
          i = { element: !1, reference: !1, position_x: 0, position_y: 0, items: [], html: '', is_visible: !1 };
        (e.vakata.context = {
          ...
          _execute: function (t) {
            return (
              !(
                !(t = i.items[t]) ||
                (t._disabled &&
                  (!e.vakata.is_function(t._disabled) || t._disabled({ item: t, reference: i.reference, element: i.element }))) ||
                !t.action
              ) &&
              t.action.call(null, { item: t, reference: i.reference, element: i.element, position: { x: i.position_x, y: i.position_y } })
            );
          },
          _parse: function (t, r) {
            if (!t) return !1;
                ...
                i.items.push(r),
                  !n &&
                    ...
                    (a +=
                      ...
                      (e.vakata.context.settings.icons ? '' : 'class="vakata-context-no-icons"') +
                      '>&#160;</a></li>'),
                  (n = !1),
                  (a +=
                    "<li class='" +
                    (r._class || '') +
                    (!0 === r._disabled ||
                    (e.vakata.is_function(r._disabled) && r._disabled({ item: r, reference: i.reference, element: i.element }))
                  ...
                  e.vakata.context.settings.icons &&
                    ...
                    r.icon &&
                      (-1 !== r.icon.indexOf('/') || -1 !== r.icon.indexOf('.')
                        ? (a += ' style=\'background:url("' + r.icon + '") center center no-repeat\' ')
                        : (a += " class='" + r.icon + "' ")),
                    (a += "></i><span class='vakata-contextmenu-sep'>&#160;</span>")),
                  (a +=
                    (e.vakata.is_function(r.label) ? r.label({ item: t, reference: i.reference, element: i.element }) : r.label) +
                    (r.shortcut
          ...
          show: function (r, s, a) {
            ...
            r && !a && e(r).data('vakata_contextmenu') && (a = e(r).data('vakata_contextmenu')),
              ...
              i.items.length &&
                ...
                c + h + 20 > g && (c = g - (h + 20)),
                l + _ + 20 > u && (l = u - (_ + 20)),
                i.element.css({ left: c, top: l }).show().find('a').first().trigger('focus').parent().addClass('vakata-context-hover'),
                (i.is_visible = !0),
                    ...
                    case 38:
                      i.is_visible &&
                        ((r = i.element
                          ...
                          .first()).length ||
                          (r = i.element.find('ul:visible').addBack().last().children('li:not(.vakata-context-separator)').last()),
                    ...
                    case 40:
                      i.is_visible &&
                        ((r = i.element
                          ...
                          .first()).length ||
                          (r = i.element.find('ul:visible').addBack().last().children('li:not(.vakata-context-separator)').first()),
                        r.addClass('vakata-context-hover').children('a').trigger('focus'),
                        t.stopImmediatePropagation(),
                        t.preventDefault());
                      break;
              ...
              this.element.on(
                ...
                function (t) {
                  ...
                  if (
                    ...
                    if (
                      ((h = { jstree: !0, origin: this, obj: this.get_node(i, !0), nodes: r > 1 ? this.get_top_selected() : [i.id] }),
                      (_ = t.currentTarget),
              ...
              this.settings.dnd.use_html5 &&
                this.element
                  .on('dragover.jstree', function (t) {
                    return t.preventDefault(), e.vakata.dnd._trigger('move', t, { helper: e(), element: _, data: h }), !1;
                  })
                  .on(
                    'drop.jstree',
                    function (t) {
                      return t.preventDefault(), e.vakata.dnd._trigger('stop', t, { helper: e(), element: _, data: h }), !1;
                    }.bind(this)
                  );
          }),
      ...
      e(function () {
        ...
        e(d)
          ...
          .on('drop.vakata.jstree', function (t) {
            _ && (e.vakata.dnd._trigger('stop', t, { helper: e(), element: _, data: h }), (_ = null), (h = null));
          })
          ...
          .on('dnd_move.vakata.jstree', function (o, d) {
            ...
            if (
              ...
              if (T && T._data && T._data.dnd)
                if (
                  (n.attr('class', 'jstree-' + T.get_theme() + (T.settings.core.themes.responsive ? ' jstree-dnd-responsive' : '')),
                  (w =
                    d.data.origin &&
                  ...
                  d.helper
                    ...
                    .attr(
                      ...
                      'jstree-' +
                        ...
                        T.get_theme_variant() +
                        ' ' +
                        (T.settings.core.themes.responsive ? ' jstree-dnd-responsive' : '')
                    )
                    .find('.jstree-copy')
                    .first()
                    [w ? 'show' : 'hide'](),
                  (d.event.target !== T.element[0] && d.event.target !== T.get_container_ul()[0]) ||
                  ...
                  if (
                    ...
                    e.each(f, function (t, s) {
                      switch (s) {
                        case 'b':
                          (l = A.left - 6), (h = A.top), (g = T.get_parent(O)), (u = O.parent().index()), (N = 'jstree-below');
                          break;
                        case 'i':
                          (y = T.settings.dnd.inside_pos),
                            ...
                            (h = A.top + _ / 2 + 1),
                            (g = x.id),
                            (u = 'first' === y ? 0 : 'last' === y ? x.children.length : Math.min(y, x.children.length)),
                            (N = 'jstree-inside');
                          break;
                        case 'a':
                          (l = A.left - 6), (h = A.top + _), (g = T.get_parent(O)), (u = O.parent().index() + 1), (N = 'jstree-above');
                      }
                        ...
                        if (
                          ((j =
                            ...
                            (d.data.origin.settings.dnd.always_copy ||
                              (d.data.origin.settings.dnd.copy && (d.event.metaKey || d.event.ctrlKey)))
                              ? 'copy_node'
                              : 'move_node'),
                          (k = u),
                          'move_node' === j &&
                            ...
                            ((b = T.get_node(g)), k > e.inArray(d.data.nodes[m], b.children) && (k -= 1)),
                          !(p =
                            p &&
                            ((T && T.settings && T.settings.dnd && !1 === T.settings.dnd.check_while_dragging) ||
                              T.check(
                                j,
                                d.data.origin && d.data.origin !== T ? d.data.origin.get_node(d.data.nodes[m]) : d.data.nodes[m],
                                g,
                                k,
                                {
                                  dnd: !0,
                      ...
                      if (
                        ...
                        return (
                          (C = T.get_node(g, !0)).hasClass('.jstree-dnd-parent') ||
                            (e('.jstree-dnd-parent').removeClass('jstree-dnd-parent'), C.addClass('jstree-dnd-parent')),
                          (i = { ins: T, par: g, pos: 'i' !== s || 'last' !== y || 0 !== u || T.is_loaded(x) ? u : 'last' }),
                          n.css({ left: l + 'px', top: h + 'px' }).show(),
                          n.removeClass('jstree-above jstree-inside jstree-below').addClass(N),
            ...
            (o = e.vakata.dnd._get()) &&
              ...
              ('keyup' === t.type && 27 === t.which
                ...
                : (o.helper
                    ...
                    [
                      o.data.origin &&
                      (o.data.origin.settings.dnd.always_copy || (o.data.origin.settings.dnd.copy && (t.metaKey || t.ctrlKey)))
                        ? 'show'
                        : 'hide'
                    ](),
            ...
            if (
              ...
              return (
                ...
                i.helper &&
                  ...
                  (g = parseInt(t.pageX + e.vakata.dnd.settings.helper_left, 10)),
                  a && _ + 25 > a && (_ = a - 50),
            ...
            if (!s) {
              for (n = 0, o = t.length; n < o; n++)
                (h[t[n]] && (h[t[n]].state.loaded || h[t[n]].state.failed) && !a) ||
                  (l.push(t[n]), (d = this.get_node(t[n], !0)) && d.length && d.addClass('jstree-loading').attr('aria-busy', !0));
        ...
        (this.bind = function () {
                  ...
                  if (this._data.search.som && i.res.length) {
                    ...
                    for (r = 0, s = i.res.length; r < s; r++)
                      if (
                        ...
                        (d.push(i.res[r]), (d = d.concat(o[i.res[r]].parents)), this._data.search.smc)
                      )
          ...
          (this.search = function (i, r, s, a, n, o) {
            ...
            if (
              ...
              (g = new e.vakata.search(i, !0, { caseSensitive: l.case_sensitive, fuzzy: l.fuzzy })),
              e.each(_[a || e.jstree.root].children_d, function (e, t) {
                var r = _[t];
                r.text &&
                  !r.state.hidden &&
                  (!l.search_leaves_only || (r.state.loaded && 0 === r.children.length)) &&
                  ((l.search_callback && l.search_callback.call(this, i, r)) || (!l.search_callback && g.search(r.text).isMatch)) &&
              ...
              n
                ? ((this._data.search.dom = this._data.search.dom.add(
                  ...
                  (this._data.search.res = e.vakata.array_unique(this._data.search.res.concat(u))))
                : ((this._data.search.dom = e(
                    this.element[0].querySelectorAll(
                      '#' +
                        e
            ...
            this.trigger('search', { nodes: this._data.search.dom, str: i, res: this._data.search.res, show_only_matches: s });
          }),
      ...
      (function (e) {
        (e.vakata.search = function (t, i, r) {
          ...
          return (
            ...
            (o = function (e) {
              ...
              var i,
                ...
                x = [];
              for (
                -1 !== k && ((j = Math.min(n(0, k), j)), -1 !== (k = e.lastIndexOf(t, d + h)) && (j = Math.min(n(0, k), j))), k = -1, i = 0;
                i < h;
                i++
              ) {
                for (c = 0, _ = b; c < _; ) n(i, d + _) <= j ? (c = _) : (b = _), (_ = Math.floor((b - c) / 2 + c));
                for (
                  b = _, u = Math.max(1, d - _ + 1), f = Math.min(d + _, v) + h, (p = new Array(f + 2))[f + 1] = (1 << i) - 1, o = f;
                  o >= u;
                  o--
                )
                  if (
                    ((m = a[e.charAt(o - 1)]),
                    (p[o] = 0 === i ? ((p[o + 1] << 1) | 1) & m : (((p[o + 1] << 1) | 1) & m) | ((g[o + 1] | g[o]) << 1) | 1 | g[o + 1]),
                    p[o] & s && (y = n(i, o - 1)) <= j)
                  ) {
          ...
          (e.vakata.search.defaults = { location: 0, distance: 100, threshold: 0.6, fuzzy: !1, caseSensitive: !1 });
      })(e),
      ...
      (e.jstree.plugins.types = function (i, r) {
        (this.init = function (i, s) {
                  ...
                  if ((d = this.get_rules(a)).max_children !== t && -1 !== d.max_children && d.max_children === a.children.length)
                    return (
                      (this._data.core.last_error = {
                        ...
                        data: JSON.stringify({ chk: i, pos: n, obj: !(!s || !s.id) && s.id, par: !(!a || !a.id) && a.id }),
                      }),
                      !1
                    );
          ...
          (this.get_type = function (t, i) {
            return !!(t = this.get_node(t)) && (i ? e.extend({ type: t.type }, this.settings.types[t.type]) : t.type);
          }),
            ...
            if (
              ...
              for (c in s[o].li_attr)
                if (s[o].li_attr.hasOwnProperty(c)) {
                  if ('id' === c) continue;
                  'class' === c
                    ? ((_[i.id].li_attr.class = (_[i.id].li_attr.class || '').replace(s[o].li_attr[c], '')),
            ...
            if (s[o] && s[o].a_attr !== t && 'object' == typeof s[o].a_attr)
              for (c in s[o].a_attr)
                if (s[o].a_attr.hasOwnProperty(c)) {
                  if ('id' === c) continue;
                  'class' === c
                    ? ((_[i.id].a_attr.class = (_[i.id].a_attr.class || '').replace(s[o].a_attr[c], '')),
                ...
                if (s[r].li_attr.hasOwnProperty(c)) {
                  ...
                  _[i.id].li_attr[c] === t
                    ? ((_[i.id].li_attr[c] = s[r].li_attr[c]),
                      l && ('class' === c ? l.addClass(s[r].li_attr[c]) : l.attr(c, s[r].li_attr[c])))
                    : 'class' === c &&
                      ((_[i.id].li_attr.class = s[r].li_attr[c] + ' ' + _[i.id].li_attr.class), l && l.addClass(s[r].li_attr[c]));
                }
              ...
              for (c in s[r].a_attr)
                if (s[r].a_attr.hasOwnProperty(c)) {
                  ...
                  _[i.id].a_attr[c] === t
                    ...
                    : 'class' === c &&
                      ((_[i.id].a_attr.class = s[r].a_attr.class + ' ' + _[i.id].a_attr.class), h && h.addClass(s[r].a_attr[c]));
                }
            return !0;
          });
      }),
        ...
        (this.check = function (t, i, s, a, n) {
          ...
          for (o = 0, d = s.children.length; o < d; o++)
            (c = u[s.children[o]].text),
              ...
              h.push(c);
          switch ((_ || (l = l.toLowerCase()), g && (l = l.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, '')), t)) {
            case 'delete_node':
              return !0;
            case 'rename_node':
              return (
                ...
                (o = -1 === e.inArray(l, h) || (i.text && c === l)) ||
                  (this._data.core.last_error = {
                    ...
                    data: JSON.stringify({ chk: t, pos: a, obj: !(!i || !i.id) && i.id, par: !(!s || !s.id) && s.id }),
                  }),
                o
              );
            case 'create_node':
          ...
          (this.create_node = function (i, s, a, n, o) {
            if (!s || s.text === t) {
              ...
              for (c = d = this.get_string('New node'), l = [], h = 0, _ = i.children.length; h < _; h++)
                (g = u[i.children[h]].text),
                  f || (g = g.toLowerCase()),
                  p && (g = g.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, '')),
                  l.push(g);
              for (
                h = 1, g = c, f || (g = g.toLowerCase()), p && (g = g.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, ''));
                -1 !== e.inArray(g, l);
          ...
          i.bind.call(this),
            this.element
              ...
              .on('dblclick.jstree', '.jstree-wholerow', function (t) {
                t.stopImmediatePropagation();
                var i = e.Event('dblclick', { metaKey: t.metaKey, ctrlKey: t.ctrlKey, altKey: t.altKey, shiftKey: t.shiftKey });
                e(t.currentTarget).closest('.jstree-node').children('.jstree-anchor').first().trigger(i).trigger('focus');
              })
              .on(
                'click.jstree',
