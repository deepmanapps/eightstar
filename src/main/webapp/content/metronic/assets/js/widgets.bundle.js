      ...
      if (e) {
        var t = function (e) {
          ...
          var t = document.createElement('span'),
            a = '';
          return (
            (a += '<img src="' + e.element.getAttribute('data-kt-select2-icon') + '" class="rounded-circle h-20px me-2" alt="image"/>'),
            (a += e.text),
            (t.innerHTML = a),
            $(t)
          );
        ...
        if (e) {
          var t,
            a = function () {
              ...
              var r = a.series.push(
                am5map.MapPolygonSeries.new(t, { geoJSON: am5geodata_worldLow, include: ['US', 'BR', 'DE', 'AU', 'JP'] })
              );
              ...
              var a = Date.now(),
                ...
                i = {
                  ...
                  xss: {
                    disabled: !1,
                    filterOptions: {
                      whiteList: { div: ['class', 'style'], img: ['data-kt-timeline-avatar-src', 'alt'], a: ['href', 'class'] },
                    },
                  },
                  template: function (e) {
                    const t = e.users;
      ...
      (() => {
        ...
        var a = Date.now(),
          ...
          i = {
            ...
            xss: {
              disabled: !1,
              filterOptions: { whiteList: { div: ['class', 'style'], img: ['data-kt-timeline-avatar-src', 'alt'], a: ['href', 'class'] } },
            },
            template: function (e) {
              const t = e.users;
              let a = '';
      ...
      if (o) {
        var i = parseInt(KTUtil.css(o, 'height')),
          ...
          d = {
            ...
            plotOptions: {
              bar: { horizontal: !1, columnWidth: ['22%'], borderRadius: 5, dataLabels: { position: 'top' }, startingShape: 'flat' },
            },
            legend: { show: !1 },
            dataLabels: {
              enabled: !0,
          ...
          var t,
            a = function () {
              ...
              r.createAxisRange(s),
                s
                  .get('grid')
                  .setAll({ stroke: am5.color(KTUtil.getCssVariableValue('--bs-gray-200')), strokeOpacity: 0.5, strokeDasharray: [3] }),
              ...
              r.createAxisRange(n),
                n
                  .get('grid')
                  .setAll({ stroke: am5.color(KTUtil.getCssVariableValue('--bs-danger')), strokeOpacity: 1, strokeDasharray: [3] }),
                n
                  .get('label')
                  .setAll({
                    inside: !0,
      ...
      if ('undefined' != typeof am5) {
        ...
        e &&
          am5.ready(function () {
            ...
            var d = a.series.push(
              am5radar.RadarColumnSeries.new(t, { xAxis: o, yAxis: s, clustered: !1, valueXField: 'value', categoryYField: 'category' })
            );
                  ...
                  am5xy.CategoryAxis.new(t, {
                    ...
                    bullet: function (e, t, a) {
                      return am5xy.AxisBullet.new(e, {
                        location: 0.5,
                        sprite: am5.Picture.new(e, { width: 24, height: 24, centerY: am5.p50, centerX: am5.p50, src: a.dataContext.icon }),
                      });
                    },
                  })
                );
        ...
        if (e) {
          var t,
            a = function () {
              (t = am5.Root.new(e)).setThemes([am5themes_Animated.new(t)]);
              var a = t.container.children.push(
                  am5xy.XYChart.new(t, { panX: !1, panY: !1, wheelX: 'panX', wheelY: 'zoomX', layout: t.verticalLayout })
                ),
                l =
                  (a.get('colors'),
                  [
              ...
              var r = a.xAxes.push(
                am5xy.CategoryAxis.new(t, { categoryField: 'country', renderer: am5xy.AxisRendererX.new(t, { minGridDistance: 30 }) })
              );
              r
                .get('renderer')
                .labels.template.setAll({
              ...
              s
                .get('renderer')
                .labels.template.setAll({ fontWeight: '400', fontSize: 13, fill: am5.color(KTUtil.getCssVariableValue('--bs-gray-500')) }),
          ...
          var t,
            a = function () {
              ...
              var a = t.container.children
                .push(
                  am5percent.PieChart.new(t, { startAngle: 180, endAngle: 360, layout: t.verticalLayout, innerRadius: am5.percent(50) })
                )
                .series.push(
      ...
      if (t) {
        var a = parseInt(KTUtil.css(t, 'height')),
          ...
          o = {
            ...
            plotOptions: {
              bar: { horizontal: !1, columnWidth: ['28%'], borderRadius: 5, dataLabels: { position: 'top' }, startingShape: 'flat' },
            },
            legend: { show: !1 },
            dataLabels: {
              enabled: !0,
        ...
        if ('undefined' != typeof am5) {
          ...
          if (t) {
            var a = function () {
              ...
              n.columns.template.setAll({ width: am5.p100, fillOpacity: 0.08, strokeOpacity: 0, cornerRadius: 20 }), n.data.setAll(l);
              var d = a.series.push(
                am5radar.RadarColumnSeries.new(e, { xAxis: o, yAxis: s, clustered: !1, valueXField: 'value', categoryYField: 'category' })
              );
              d.columns.template.setAll({
                width: am5.p100,
                strokeOpacity: 0,
          ...
          var t,
            a = function () {
              ...
              n.data.setAll(a.series.values),
                n.labels.template.setAll({ fontWeight: '600', fontSize: 14, fill: am5.color(KTUtil.getCssVariableValue('--bs-gray-700')) }),
                a.appear(1e3, 100),
                i.appear();
            };
          am5.ready(function () {
          ...
          var t,
            a = function () {
              ...
              s
                ...
                s.data.setAll(a);
              var n = i.yAxes.push(
                am5xy.CategoryAxis.new(t, { categoryField: 'age', renderer: am5xy.AxisRendererY.new(t, { opposite: !0 }) })
              );
              n
                .get('renderer')
                .grid.template.setAll({
              ...
              c.columns.template.setAll({
                ...
                i.plotContainer.children.push(
                  am5.Label.new(t, { text: 'Males', fontSize: 13, fontWeight: '500', y: 5, x: 5, fill: m.get('fill') })
                ),
                i.plotContainer.children.push(
                  am5.Label.new(t, {
                    text: 'Females',
          ...
          var t,
            a = function () {
              ...
              s.strokes.template.setAll({ strokeOpacity: 0 }),
                s.fills.template.setAll({ visible: !0, fill: am5.color(KTUtil.getCssVariableValue('--bs-primary')), fillOpacity: 0.5 });
              var n = a.series.push(
                am5radar.RadarLineSeries.new(t, {
                  name: 'Expense',
                  xAxis: r,
              ...
              d.data.setAll([s, n]),
                d.labels.template.setAll({ fontWeight: '600', fontSize: 13, fill: am5.color(KTUtil.getCssVariableValue('--bs-gray-700')) });
              var m = [
            ...
            a = function () {
              if ((t = am5.Root.new(e))) {
                ...
                l.labels.template.setAll({ radius: 10 }),
                  l.grid.template.setAll({ stroke: am5.color(KTUtil.getCssVariableValue('--bs-gray-700')) });
                ...
                var o = a.xAxes.push(
                    am5xy.CategoryAxis.new(t, { maxDeviation: 0, categoryField: 'category', renderer: l, tooltip: am5.Tooltip.new(t, {}) })
                  ),
                ...
                var s = a.series.push(
                  am5radar.RadarColumnSeries.new(t, { xAxis: o, yAxis: i, valueYField: 'value', categoryXField: 'category' })
                );
    ...
    t = function () {
      ...
      if (t) {
        var a = parseInt(KTUtil.css(t, 'height')),
          ...
          i = {
            series: [
              { name: 'Sales', data: [34.5, 34.5, 35, 35, 35.5, 35.5, 35, 35, 35.5, 35.5, 35, 35, 34.5, 34.5, 35, 35, 35.5, 35.5, 35] },
            ],
            chart: { fontFamily: 'inherit', type: 'area', height: a, toolbar: { show: !1 } },
            plotOptions: {},
            legend: { show: !1 },
