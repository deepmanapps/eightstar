      ...
      !(function () {
        ...
        'undefined' != typeof countUp &&
          ...
          [].slice.call(document.querySelectorAll('[data-kt-countup-tabs="true"][data-bs-toggle="tab"]')).map(function (e) {
            '1' !== e.getAttribute('data-kt-initialized') &&
              (e.addEventListener('shown.bs.tab', o), e.setAttribute('data-kt-initialized', '1'));
          }),
          (n = !0)),
  ...
  (KTDrawer.init = function () {
    KTDrawer.createInstances(),
      !1 === KTDrawerHandlersInitialized &&
        (KTDrawer.handleResize(), KTDrawer.handleShow(), KTDrawer.handleDismiss(), (KTDrawerHandlersInitialized = !0));
  }),
...
var KTEventHandler = (function () {
  var e = {},
    t = function (t, n, i, r) {
      ...
      return (
        a || (a = []), a.push(o), KTUtil.data(t).set(n, a), e[n] || (e[n] = {}), (e[n][o] = { name: n, callback: i, one: r, fired: !1 }), o
      );
    };
  return {
        ...
        if (!0 === KTUtil.data(t).has(n))
          for (var a, l = KTUtil.data(t).get(n), s = 0; s < l.length; s++)
            if (((a = l[s]), e[n] && e[n][a])) {
              var u = e[n][a];
              u.name === n &&
                (1 == u.one ? 0 == u.fired && ((e[n][a].fired = !0), (r = u.callback.call(this, i))) : (r = u.callback.call(this, i)),
                !1 === r && (o = !1));
            }
        return o;
      })(t, n, i);
    ...
    (t.show = function () {
      return (function () {
        if (!1 !== KTEventHandler.trigger(t.element, 'kt.feedback.show', t))
          return 'popup' === t.options.type && o(), KTEventHandler.trigger(t.element, 'kt.feedback.shown', t), t;
      })();
    }),
    (t.hide = function () {
      return (function () {
        if (!1 !== KTEventHandler.trigger(t.element, 'kt.feedback.hide', t))
          return 'popup' === t.options.type && l(), (t.shown = !1), KTEventHandler.trigger(t.element, 'kt.feedback.hidden', t), t;
      })();
    }),
    (t.isShown = function () {
      return t.shown;
      ...
      l = function (e) {
        e.preventDefault(),
          !1 !== KTEventHandler.trigger(n.element, 'kt.imageinput.cancel', n) &&
            ...
            n.element.classList.remove('image-input-empty'),
            'none' === n.src
              ? (KTUtil.css(n.wrapperElement, 'background-image', ''), n.element.classList.add('image-input-empty'))
      ...
      var i = { dropdown: { hoverTimeout: 200, zindex: 107 }, accordion: { slideSpeed: 250, expand: !1 } },
        ...
        a = function (e) {
          e || (e = n.triggerElement),
            !0 !== m(e) && ('dropdown' === v(e) ? y(e) : 'accordion' === v(e) && A(e), KTUtil.data(e).set('type', v(e)));
        },
        l = function (e) {
        ...
        y = function (e) {
          if (!1 !== KTEventHandler.trigger(n.element, 'kt.menu.dropdown.show', e)) {
            ...
            null !== a && a >= o && (o = a + 1),
              ...
              !0 === L(e, 'overflow')
                ? (document.body.appendChild(t), KTUtil.data(e).set('sub', t), KTUtil.data(t).set('item', e), KTUtil.data(t).set('menu', n))
          ...
          return (function (e, t) {
            ...
            !0 !== n.disabled &&
              ...
              ('1' === KTUtil.data(i).get('hover') &&
                (clearTimeout(KTUtil.data(i).get('timeout')), KTUtil.data(i).remove('hover'), KTUtil.data(i).remove('timeout')),
              a(i));
          })(e);
        }),
    ...
    if (t && t.length > 0)
      for (var n = 0, i = t.length; n < i; n++) {
        ...
        o &&
          ...
          (e ? !1 === o.getItemSubElement(r).contains(e) && !1 === r.contains(e) && r !== e && o.hide(r) : o.hide(r));
      }
  }),
  ...
  return {
    ...
    deepExtend: function (e) {
      ...
      for (var t = 1; t < arguments.length; t++) {
        ...
        if (n)
          for (var i in n)
            n.hasOwnProperty(i) &&
              ('[object Object]' !== Object.prototype.toString.call(n[i]) ? (e[i] = n[i]) : (e[i] = KTUtil.deepExtend(e[i], n[i])));
      }
      return e;
    },
    extend: function (e) {
      ...
      return {
        ...
        has: function (t) {
          return (
            ...
            !(!window.KTUtilElementDataStore[e.customDataTag] || !window.KTUtilElementDataStore[e.customDataTag][t])
          );
        },
        remove: function (t) {
    ...
    off: function (e, t, n) {
      e &&
        ...
        (KTUtil.removeEvent(e, t, window.KTUtilDelegatedEventHandlers[n]), delete window.KTUtilDelegatedEventHandlers[n]);
    },
    one: function (e, t, n) {
