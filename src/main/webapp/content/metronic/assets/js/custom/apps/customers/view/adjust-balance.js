  ...
  return {
    init: function () {
      (t = document.querySelector('#kt_modal_adjust_balance')),
        ...
        Inputmask('US$ 9,999,999.99', { numericInput: !0 }).mask('#kt_modal_inputmask'),
        (function () {
          ...
          (a = n ? -1 * a : a),
            i.addEventListener('focusout', function (t) {
              (o = parseFloat(t.target.value.replace(/[^0-9.]/g, '').replace(',', ''))),
                isNaN(o) && (o = 0),
                (r.innerHTML = 'US$ ' + (o + a).toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,'));
            });
        })(),
        (a = FormValidation.formValidation(l, {
          fields: {
            adjustment: { validators: { notEmpty: { message: 'Adjustment type is required' } } },
