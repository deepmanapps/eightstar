  ...
  return {
    init: function () {
      (o = document.querySelector('#kt_modal_select_location')) &&
        ...
        document.querySelector('#kt_modal_select_location_button').addEventListener('click', function () {
            ...
            (!(function () {
              if (L) {
                ...
                L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
                  ...
                  (t = void 0 === L.esri.Geocoding ? L.esri.geocodeService() : L.esri.Geocoding.geocodeService());
                  ...
                  t.reverse()
                    ...
                    .run(function (t, o) {
                      t ||
                        ...
                        L.marker(o.latlng, { icon: c }).addTo(n).bindPopup(o.address.Match_addr, { closeButton: !1 }).openPopup(),
                        Swal.fire({
                          html:
