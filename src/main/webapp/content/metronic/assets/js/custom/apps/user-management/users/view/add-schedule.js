...
var KTUsersAddSchedule = (function () {
  ...
  return {
    init: function () {
      (() => {
        $('#kt_modal_add_schedule_datepicker').flatpickr({ enableTime: !0, dateFormat: 'Y-m-d H:i' });
        ...
        var i = FormValidation.formValidation(e, {
          fields: {
            event_datetime: { validators: { notEmpty: { message: 'Event date & time is required' } } },
            event_name: { validators: { notEmpty: { message: 'Event name is required' } } },
            event_org: { validators: { notEmpty: { message: 'Event organiser is required' } } },
            event_invitees: { validators: { notEmpty: { message: 'Event invitees is required' } } },
          },
          plugins: {
