            ...
            l = new Tagify(o, {
              ...
              templates: {
                tag: function (e) {
                  ...
                  try {
                    return `<tag title='${e.value}' contenteditable='false' spellcheck="false" class='tagify__tag ${
                      e.class ? e.class : ''
                    }' ${this.getAttributes(
                      e
        ...
        l.push(
          FormValidation.formValidation(a, {
            fields: {
              ...
              avatar: {
                validators: {
                  file: { extension: 'png,jpg,jpeg', type: 'image/jpeg,image/png', message: 'Please choose a png, jpg or jpeg files only' },
                },
              },
            },
            plugins: {
