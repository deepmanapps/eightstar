  ...
  const l = () => {
    ...
    s = () => {
      ...
      r.forEach(e => {
        ...
        a
          ? ((n.innerHTML = l), e.classList.add('d-none'), o.classList.remove('d-none'))
                    ...
                    'Valid' == t
                      ? setTimeout(function () {
                          ...
                          t.setAttribute('href', '?page=apps/file-manager/blank'),
                            ...
                            (t.innerText = f.value);
                          const o = e.row
                            .add({ checkbox: a.innerHTML, name: m.outerHTML + t.outerHTML, size: '-', date: '-', action: r.innerHTML })
                            .node();
                          ...
                          for (var n, l = e.row(0).index(), i = e.data().length - 1, s = e.row(i).data(), c = i; c > l; c--)
                            (n = e.row(c - 1).data()), e.row(c).data(n), e.row(c - 1).data(s);
                          (toastr.options = {
                            closeButton: !0,
                            debug: !1,
                            newestOnTop: !1,
