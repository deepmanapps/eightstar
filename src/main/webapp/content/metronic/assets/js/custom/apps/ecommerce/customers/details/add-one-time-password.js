    ...
    init: function () {
      (() => {
        var o = FormValidation.formValidation(e, {
          fields: {
            otp_mobile_number: { validators: { notEmpty: { message: 'Valid mobile number is required' } } },
            otp_confirm_password: { validators: { notEmpty: { message: 'Password confirmation is required' } } },
          },
          plugins: {
