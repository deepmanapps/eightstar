  ...
  return {
    init: function () {
      (o = KTModalCreateProject.getForm()),
        ...
        $(o.querySelector('[name="settings_release_date"]')).flatpickr({ enableTime: !0, dateFormat: 'd, M Y, H:i' }),
        ...
        (i = FormValidation.formValidation(o, {
          fields: {
            settings_name: { validators: { notEmpty: { message: 'Project name is required' } } },
            settings_customer: { validators: { notEmpty: { message: 'Customer is required' } } },
            settings_description: { validators: { notEmpty: { message: 'Description is required' } } },
            settings_release_date: { validators: { notEmpty: { message: 'Release date is required' } } },
            'settings_notifications[]': { validators: { notEmpty: { message: 'Notifications are required' } } },
          },
          plugins: {
