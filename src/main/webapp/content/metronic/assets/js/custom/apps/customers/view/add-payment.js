    ...
    init: function () {
      (t = document.querySelector('#kt_modal_add_payment')),
        ...
        (i = FormValidation.formValidation(a, {
          fields: {
            invoice: { validators: { notEmpty: { message: 'Invoice number is required' } } },
            status: { validators: { notEmpty: { message: 'Invoice status is required' } } },
            amount: { validators: { notEmpty: { message: 'Invoice amount is required' } } },
          },
          plugins: {
