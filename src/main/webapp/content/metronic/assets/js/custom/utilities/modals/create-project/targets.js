  ...
  return {
    init: function () {
      (r = KTModalCreateProject.getForm()),
        ...
        $(r.querySelector('[name="target_due_date"]')).flatpickr({ enableTime: !0, dateFormat: 'd, M Y, H:i' }),
        ...
        (a = FormValidation.formValidation(r, {
          fields: {
            ...
            target_assign: { validators: { notEmpty: { message: 'Customer is required' } } },
            target_due_date: { validators: { notEmpty: { message: 'Due date is required' } } },
            target_tags: { validators: { notEmpty: { message: 'Target tags are required' } } },
            target_allow: { validators: { notEmpty: { message: 'Allowing target is required' } } },
            'target_notifications[]': { validators: { notEmpty: { message: 'Notifications are required' } } },
          },
          plugins: {
