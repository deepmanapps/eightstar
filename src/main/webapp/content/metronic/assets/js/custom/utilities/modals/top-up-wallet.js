      ...
      (e = document.querySelector('#kt_modal_top_up_wallet')) &&
        ...
        (l = new KTStepper(o)).on('kt.stepper.changed', function (t) {
          4 === l.getCurrentStepIndex()
            ? (a.classList.remove('d-none'), a.classList.add('d-inline-block'), r.classList.add('d-none'))
            : 5 === l.getCurrentStepIndex()
            ? (a.classList.add('d-none'), r.classList.add('d-none'))
            : (a.classList.remove('d-inline-block'), a.classList.remove('d-none'), r.classList.remove('d-none'));
        }),
        ...
        i.push(
          FormValidation.formValidation(n, {
            fields: { top_up_amount: { validators: { notEmpty: { message: 'Top up amount is required' } } } },
            plugins: {
        ...
        i.push(
          FormValidation.formValidation(n, {
            fields: { payment_methods: { validators: { notEmpty: { message: 'Payment method is required' } } } },
            plugins: {
              trigger: new FormValidation.plugins.Trigger(),
              bootstrap: new FormValidation.plugins.Bootstrap5({ rowSelector: '.fv-row', eleInvalidClass: '', eleValidClass: '' }),
            },
        ...
        i.push(
          FormValidation.formValidation(n, {
            fields: { top_up_password: { validators: { notEmpty: { message: 'Password is required' } } } },
            plugins: {
              trigger: new FormValidation.plugins.Trigger(),
              bootstrap: new FormValidation.plugins.Bootstrap5({ rowSelector: '.fv-row', eleInvalidClass: '', eleValidClass: '' }),
            },
