...
export class LayoutComponent implements OnInit, OnDestroy {
  ...
  updateToolbar(config: ILayout) {
    ...
    if (this.appToolbarSwapEnabled) {
      this.appToolbarSwapAttributes = this.layout.getProp('app.toolbar.swap.attributes', config) as { [attrName: string]: string };
    }
    ...
    if (this.appToolbarStickyEnabled) {
      this.appToolbarStickyAttributes = this.layout.getProp('app.toolbar.sticky.attributes', config) as { [attrName: string]: string };
    }
    ...
    if (this.appToolbarMinimizeEnabled) {
      this.appToolbarMinimizeAttributes = this.layout.getProp('app.toolbar.minimize.attributes', config) as { [attrName: string]: string };
