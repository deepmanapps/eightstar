...
public class HotelServicesResource {
    ...
    public ResponseEntity<List<HotelServicesDTO>> getAllHotelServices(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of HotelServices");
        Page<HotelServicesDTO> page = hotelServicesService.findAll(pageable);
