...
public class ProductRequestResource {
    ...
    public ResponseEntity<List<ProductRequestDTO>> getAllProductRequests(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of ProductRequests");
        Page<ProductRequestDTO> page = productRequestService.findAll(pageable);
