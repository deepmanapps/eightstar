...
public class ParkingAllResource {
    ...
    public ResponseEntity<List<ParkingAllDTO>> getAllParkingAlls(
        ...
        if ("servicerequest-is-null".equals(filter)) {
            ...
            return new ResponseEntity<>(parkingAllService.findAllWhereServiceRequestIsNull(), HttpStatus.OK);
        }
        log.debug("REST request to get a page of ParkingAlls");
        Page<ParkingAllDTO> page = parkingAllService.findAll(pageable);
