package com.altair.eightstar.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.altair.eightstar.IntegrationTest;
import com.altair.eightstar.repository.timezone.DateTimeWrapper;
import com.altair.eightstar.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM es_date_time_wrapper where id=%d", fieldName, id);
    }
