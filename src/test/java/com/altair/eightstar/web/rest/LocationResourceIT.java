...
class LocationResourceIT {
    ...
    public static Location createEntity(EntityManager em) {
        Location location = new Location().longitude(DEFAULT_LONGITUDE).latitude(DEFAULT_LATITUDE);
        return location;
    }
    ...
    public static Location createUpdatedEntity(EntityManager em) {
        Location location = new Location().longitude(UPDATED_LONGITUDE).latitude(UPDATED_LATITUDE);
        return location;
    }
    ...
    void putExistingLocation() throws Exception {
        ...
        updatedLocation.longitude(UPDATED_LONGITUDE).latitude(UPDATED_LATITUDE);
    ...
    void partialUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.longitude(UPDATED_LONGITUDE);
    ...
    void fullUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.longitude(UPDATED_LONGITUDE).latitude(UPDATED_LATITUDE);
